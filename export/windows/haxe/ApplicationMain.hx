...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Windows Haxe", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Windows Haxe", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Windows Haxe";
		app.meta["name"] = "Installing Windows 7";
		...
		#elseif air
		app.window.title = "Installing Windows 7";
		#else
		app.window.context.attributes.background = 0;
		app.window.frameRate = 75;
		#end
