...
HXLINE(  19)		this->makeGraphic(2,2,-1,null(),null());
...
HXLINE(  48)		if (::hx::IsPointerEq( this->axis,::flixel::addons::ui::LineAxis_obj::HORIZONTAL_dyn() )) {
HXLINE(  50)			 ::flixel::math::FlxBasePoint this1 = this->scale;
HXDLIN(  50)			Float y = (((Float)0.5) * this->thickness);
HXDLIN(  50)			this1->set_x((((Float)0.5) * this->length));
HXDLIN(  50)			this1->set_y(y);
            		}
            		else {
HXLINE(  54)			 ::flixel::math::FlxBasePoint this2 = this->scale;
HXDLIN(  54)			Float y1 = (((Float)0.5) * this->length);
HXDLIN(  54)			this2->set_x((((Float)0.5) * this->thickness));
HXDLIN(  54)			this2->set_y(y1);
            		}
...
HXDLIN(  60)		if (::hx::IsPointerEq( this->axis,::flixel::addons::ui::LineAxis_obj::HORIZONTAL_dyn() )) {
