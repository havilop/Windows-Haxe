...
HXDLIN(  35)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  35)		_this->label = HX_("name",4b,72,ff,48);
HXDLIN(  35)		_this->value = value;
HXLINE(  36)		 ::Dynamic value1 = this->label;
HXDLIN(  36)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  36)		_this1->label = HX_("label",f4,0d,af,6f);
HXDLIN(  36)		_this1->value = value1;
HXLINE(  34)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
