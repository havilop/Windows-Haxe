...
HXLINE(  86)		if (::Std_obj::isOfType(Box,( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxSprite >()) ))) {
...
HXLINE(  96)		this->button =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,Label,this->_clickCheck_dyn(),null(),null(),null());
HXLINE(  99)		( ( ::flixel::text::FlxText)(this->button->label) )->setFormat(null(),8,16777215,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),null(),null());
HXLINE( 100)		( ( ::flixel::text::FlxText)(this->button->label) )->set_fieldWidth(( (Float)(LabelW) ));
HXLINE( 101)		this->button->up_color = 16777215;
HXLINE( 102)		this->button->down_color = 16777215;
HXLINE( 103)		this->button->over_color = 16777215;
HXLINE( 104)		this->button->up_toggle_color = 16777215;
HXLINE( 105)		this->button->down_toggle_color = 16777215;
HXLINE( 106)		this->button->over_toggle_color = 16777215;
...
HXDLIN( 110)		this->max_width = ( (Float)(::Std_obj::_hx_int(((_hx_tmp3 + this->box_space) + LabelW))) );
...
HXLINE( 120)		if (::Std_obj::isOfType(Check,( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxSprite >()) ))) {
...
HXLINE( 140)		this->button->setAllLabelOffsets(( (Float)(0) ),( (Float)(0) ));
HXLINE( 142)		this->set_x(X);
HXLINE( 143)		this->set_y(Y);
HXLINE( 145)		this->set_textX(( (Float)(0) ));
HXLINE( 146)		this->set_textY(( (Float)(0) ));
            	}
...
HXLINE( 188)			 ::flixel::math::FlxBasePoint this1 = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 188)			Float x = this->box->get_width();
HXDLIN( 188)			this1->set_x(-(((x + this->box_space) + this->textX)));
            		}
            	}
...
HXDLIN( 194)			Float _hx_tmp3 = (_hx_tmp1 + ((_hx_tmp2 - this->button->get_height()) / ( (Float)(2) )));
...
HXLINE( 228)			if (::hx::IsNotNull( this->button->label )) {
HXLINE( 229)				if (::Std_obj::isOfType(this->button->label,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIText >()) ))) {
