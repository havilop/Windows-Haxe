...
HXLINE(  28)		this->stack = 1;
HXLINE(  27)		this->value = ((Float)0);
HXLINE(  26)		this->max = ((Float)10);
HXLINE(  25)		this->min = ((Float)0);
HXLINE(  24)		this->decimals = 0;
HXLINE(  23)		this->stepSize = ((Float)0);
HXLINE( 168)		super::__construct(X,Y);
HXLINE( 170)		if (::hx::IsNull( TextField )) {
HXLINE( 171)			TextField =  ::flixel::addons::ui::FlxUIInputText_obj::__alloc( HX_CTX ,0,0,25,null(),null(),null(),null(),null());
            		}
HXLINE( 173)		TextField->set_x(( (Float)(0) ));
HXLINE( 174)		TextField->set_y(( (Float)(0) ));
...
HXLINE( 178)		if (::Std_obj::isOfType(this->text_field,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIInputText >()) ))) {
HXLINE( 180)			 ::flixel::addons::ui::FlxUIInputText fuit = ( ( ::flixel::addons::ui::FlxUIInputText)(this->text_field) );
HXLINE( 181)			fuit->set_lines(1);
...
HXLINE( 193)		int btnSize = (1 + ( (int)(TextField->get_height()) ));
HXLINE( 195)		if (::hx::IsNull( ButtonPlus )) {
HXLINE( 196)			ButtonPlus =  ::flixel::addons::ui::FlxUITypedButton_obj::__alloc( HX_CTX ,0,0,null());
HXLINE( 197)			ButtonPlus->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),btnSize,btnSize,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("2,2,15,15",38,7b,83,18))),0,-1,false,18,18,null());
HXLINE( 198)			ButtonPlus->set_label( ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/plus_mark.png",e4,f7,7a,be))).StaticCast<  ::flixel::FlxSprite >();
            		}
HXLINE( 200)		if (::hx::IsNull( ButtonMinus )) {
HXLINE( 201)			ButtonMinus =  ::flixel::addons::ui::FlxUITypedButton_obj::__alloc( HX_CTX ,0,0,null());
HXLINE( 202)			ButtonMinus->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),btnSize,btnSize,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("2,2,15,15",38,7b,83,18))),0,-1,false,18,18,null());
HXLINE( 203)			ButtonMinus->set_label( ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/minus_mark.png",80,c9,b5,31))).StaticCast<  ::flixel::FlxSprite >();
            		}
...
HXLINE(  57)		if (::Std_obj::isOfType(this->text_field,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxInputText >()) ))) {
...
HXLINE(  85)				displayValue = (displayValue * ( (Float)(100) ));
HXLINE(  86)				 ::flixel::text::FlxText _hx_tmp = this->text_field;
HXDLIN(  86)				Float tens = ::Math_obj::pow(( (Float)(10) ),( (Float)(this->decimals) ));
HXDLIN(  86)				_hx_tmp->set_text((::Std_obj::string(::Std_obj::string((( (Float)(::Math_obj::round((displayValue * tens))) ) / tens))) + HX_("%",25,00,00,00)));
            			}
            			else {
HXLINE(  88)				 ::flixel::text::FlxText _hx_tmp1 = this->text_field;
HXDLIN(  88)				Float tens1 = ::Math_obj::pow(( (Float)(10) ),( (Float)(this->decimals) ));
HXDLIN(  88)				_hx_tmp1->set_text(::Std_obj::string((( (Float)(::Math_obj::round((displayValue * tens1))) ) / tens1)));
            			}
            		}
...
HXLINE( 109)		int btnSize = 10;
HXLINE( 110)		int offsetX = 0;
HXLINE( 111)		int offsetY = 0;
HXLINE( 112)		if (::Std_obj::isOfType(this->text_field,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIInputText >()) ))) {
HXLINE( 113)			offsetX = 1;
HXLINE( 114)			offsetY = 1;
            		}
HXLINE( 116)		switch((int)(this->stack)){
            			case (int)0: {
HXLINE( 130)				btnSize = (1 + ( (int)((this->text_field->get_height() / ( (Float)(2) ))) ));
HXLINE( 131)				if ((this->button_plus->get_height() != btnSize)) {
HXLINE( 132)					this->button_plus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 134)				if ((this->button_minus->get_height() != btnSize)) {
HXLINE( 135)					this->button_minus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
...
HXLINE( 138)				this->button_plus->set_y((-(offsetY) + this->text_field->y));
HXLINE( 139)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp2 = this->button_minus;
HXDLIN( 139)				Float _hx_tmp3 = (offsetX + this->text_field->x);
HXDLIN( 139)				_hx_tmp2->set_x((_hx_tmp3 + this->text_field->get_width()));
HXLINE( 140)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp4 = this->button_minus;
HXDLIN( 140)				Float _hx_tmp5 = (offsetY + this->text_field->y);
HXDLIN( 140)				Float _hx_tmp6 = this->text_field->get_height();
HXDLIN( 140)				_hx_tmp4->set_y((_hx_tmp5 + (_hx_tmp6 - this->button_minus->get_height())));
            			}
            			break;
            			case (int)1: {
HXLINE( 118)				btnSize = (2 + ( (int)(this->text_field->get_height()) ));
HXLINE( 119)				if ((this->button_plus->get_height() != btnSize)) {
HXLINE( 120)					this->button_plus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 122)				if ((this->button_minus->get_height() != btnSize)) {
HXLINE( 123)					this->button_minus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 125)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp7 = this->button_plus;
HXDLIN( 125)				Float _hx_tmp8 = (offsetX + this->text_field->x);
HXDLIN( 125)				_hx_tmp7->set_x((_hx_tmp8 + this->text_field->get_width()));
HXLINE( 126)				this->button_plus->set_y((-(offsetY) + this->text_field->y));
HXLINE( 127)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp9 = this->button_minus;
HXDLIN( 127)				Float _hx_tmp10 = this->button_plus->x;
HXDLIN( 127)				_hx_tmp9->set_x((_hx_tmp10 + this->button_plus->get_width()));
...
HXLINE( 146)		Float tens = ::Math_obj::pow(( (Float)(10) ),( (Float)(digits) ));
HXLINE( 147)		return ::Std_obj::string((( (Float)(::Math_obj::round((f * tens))) ) / tens));
            	}
...
HXLINE( 229)		int numDecimals = 0;
HXLINE( 230)		{
HXLINE( 230)			int _g = 0;
HXDLIN( 230)			int _g1 = text.length;
...
HXLINE( 235)					numDecimals = (numDecimals + 1);
            				}
            			}
            		}
HXLINE( 239)		bool justAddedDecimal;
HXDLIN( 239)		if ((numDecimals == 1)) {
HXLINE( 239)			int justAddedDecimal1 = text.indexOf(HX_(".",2e,00,00,00),null());
HXDLIN( 239)			justAddedDecimal = (justAddedDecimal1 == (text.length - 1));
            		}
            		else {
...
HXLINE( 251)		this->set_value((this->value + this->stepSize));
...
HXLINE( 257)		this->set_value((this->value - this->stepSize));
...
HXDLIN(  31)		STACK_VERTICAL = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_32_boot)
HXDLIN(  32)		STACK_HORIZONTAL = 1;
            	}
{
