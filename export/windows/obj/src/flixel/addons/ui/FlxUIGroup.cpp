...
HXDLIN(  68)				_g = (_g + 1);
HXLINE(  69)				if (::hx::IsInstanceEq( obj,Object )) {
...
HXDLIN(  82)			_hx_tmp = (this->group->members->get_length() > 0);
            		}
            		else {
...
HXLINE(  89)						if (::Std_obj::isOfType(fb,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::interfaces::IFlxUIWidget >()) ))) {
...
HXLINE(  95)							if (::Std_obj::isOfType(fb,( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxSprite >()) ))) {
...
HXLINE( 114)			this->set_width(this->set_height(( (Float)(0) )));
            		}
            	}
...
HXDLIN( 124)				_g = (_g + 1);
HXLINE( 125)				fs = fb;
HXLINE( 126)				fs->set_x(( (Float)(::Math_obj::floor(fs->x)) ));
HXLINE( 127)				fs->set_y(( (Float)(::Math_obj::floor(fs->y)) ));
            			}
            		}
            	}
