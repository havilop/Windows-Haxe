...
HX_LOCAL_STACK_FRAME(_hx_pos_032c27c33f94f39d_352_update,"flixel.addons.ui.FlxUIDropDownMenu","update",0x4f8d24f2,"flixel.addons.ui.FlxUIDropDownMenu.update","flixel/addons/ui/FlxUIDropDownMenu.hx",352,0x238549da)
...
HXDLIN( 133)			 ::openfl::geom::Rectangle rect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,rect,this->header->background->get_height());
HXLINE( 134)			this->dropPanel =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("flixel/flixel-ui/img/box.png",dd,a4,cf,5b),rect1,::Array_obj< int >::fromData( _hx_array_data_c6267e65_4,4),null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 137)		if (::hx::IsNotNull( DataList )) {
HXLINE( 139)			{
HXLINE( 139)				int _g = 0;
HXDLIN( 139)				int _g1 = DataList->length;
...
HXLINE( 144)			this->selectSomething(DataList->__get(0).StaticCast<  ::flixel::addons::ui::StrNameLabel >()->name,DataList->__get(0).StaticCast<  ::flixel::addons::ui::StrNameLabel >()->label);
            		}
            		else {
...
HXDLIN( 161)			::Array< ::Dynamic> _g4 = this->list;
HXDLIN( 161)			while((_g3 < _g4->length)){
HXLINE( 161)				 ::flixel::addons::ui::FlxUIButton btn1 = _g4->__get(_g3).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 161)				_g3 = (_g3 + 1);
...
HXLINE(  44)					if (::hx::IsNotNull( item->label )) {
...
HXLINE( 177)			 ::flixel::addons::ui::FlxUI9SliceSprite fh = this->dropPanel;
HXDLIN( 177)			Float fh1 = fh->y;
HXDLIN( 177)			fh->set_y((fh1 - this->getPanelHeight()));
            		}
            		else {
HXLINE( 179)			 ::flixel::addons::ui::FlxUI9SliceSprite fh2 = this->dropPanel;
HXDLIN( 179)			fh2->set_y((fh2->y + buttonHeight));
            		}
...
HXLINE( 182)				 ::flixel::addons::ui::FlxUIButton button = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
HXDLIN( 182)				_g = (_g + 1);
...
HXLINE( 193)		{
HXLINE( 193)			int _g = 0;
HXDLIN( 193)			int _g1 = this->list->length;
...
HXDLIN( 206)			int _g3 = this->list->length;
HXDLIN( 206)			while((_g2 < _g3)){
HXLINE( 206)				_g2 = (_g2 + 1);
HXDLIN( 206)				int i1 = (_g2 - 1);
HXLINE( 208)				if (::hx::IsNotNull( this->list->__get(i1).StaticCast<  ::flixel::addons::ui::FlxUIButton >() )) {
HXLINE( 210)					this->list->__get(i1).StaticCast<  ::flixel::addons::ui::FlxUIButton >()->set_visible(vButtons->__get(i1));
            				}
            			}
            		}
...
HXDLIN( 218)		if (::hx::IsPointerNotEq( this->dropDirection,::flixel::addons::ui::FlxUIDropDownMenuDropDirection_obj::Up_dyn() )) {
HXDLIN( 218)			if (::hx::IsPointerEq( this->dropDirection,::flixel::addons::ui::FlxUIDropDownMenuDropDirection_obj::Automatic_dyn() )) {
...
HXDLIN( 223)		Float _hx_tmp2 = (_hx_tmp1 + this->header->background->get_height());
HXDLIN( 223)		return (_hx_tmp2 > ::flixel::FlxG_obj::height);
            	}
...
HXDLIN( 228)		return (( (Float)(_hx_tmp) ) * this->header->background->get_height());
            	}
...
HXLINE( 243)						if ((i <= (this->list->length - 1))) {
...
HXLINE( 275)			this->selectSomething(DataList->__get(0).StaticCast<  ::flixel::addons::ui::StrNameLabel >()->name,DataList->__get(0).StaticCast<  ::flixel::addons::ui::StrNameLabel >()->label);
            		}
...
HXLINE( 291)			_g->onClickItem(i1);
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_032c27c33f94f39d_288_makeListButton)
HXLINE( 289)		 ::flixel::addons::ui::FlxUIButton t =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,Label,null(),null(),null(),null());
HXLINE( 290)		t->broadcastToFlxUI = false;
HXLINE( 291)		 ::flixel::addons::ui::FlxUIDropDownMenu _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 291)		int i1 = i;
HXDLIN( 291)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(_g,i1));
...
HXLINE( 297)		::Array< ::Dynamic> base = t->labelOffsets;
HXDLIN( 297)		base->__get(2).StaticCast<  ::flixel::math::FlxBasePoint >()->set_y((base->__get(2).StaticCast<  ::flixel::math::FlxBasePoint >()->y - ( (Float)(1) )));
HXLINE( 299)		t->up_color = -16777216;
HXLINE( 300)		t->over_color = -1;
HXLINE( 301)		t->down_color = -1;
HXLINE( 303)		Float _hx_tmp2 = (this->header->background->get_width() - ( (Float)(2) ));
HXDLIN( 303)		t->resize(_hx_tmp2,(this->header->background->get_height() - ( (Float)(1) )));
HXLINE( 305)		( ( ::flixel::text::FlxText)(t->label) )->set_alignment(HX_("left",07,08,b0,47));
HXLINE( 306)		t->autoCenterLabel();
HXLINE( 307)		t->set_x(( (Float)(1) ));
HXLINE( 309)		{
HXLINE( 309)			int _g1 = 0;
HXDLIN( 309)			::Array< ::Dynamic> _g2 = t->labelOffsets;
HXDLIN( 309)			while((_g1 < _g2->length)){
HXLINE( 309)				 ::flixel::math::FlxBasePoint offset = _g2->__get(_g1).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 309)				_g1 = (_g1 + 1);
HXLINE( 311)				offset->set_x((offset->x + 2));
            			}
            		}
HXLINE( 314)		return t;
            	}
...
HXLINE( 323)			_hx_tmp = ::hx::IsNotNull( btn->label );
            		}
            		else {
...
HXLINE( 330)			_hx_tmp = ::hx::IsNotNull( btn->label );
            		}
            		else {
...
void FlxUIDropDownMenu_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_032c27c33f94f39d_352_update)
HXLINE( 353)		this->super::update(elapsed);
HXLINE( 356)		bool _hx_tmp;
HXDLIN( 356)		if (this->dropPanel->visible) {
HXLINE( 356)			_hx_tmp = (::flixel::FlxG_obj::mouse->_leftButton->current == 2);
            		}
            		else {
HXLINE( 356)			_hx_tmp = false;
            		}
HXDLIN( 356)		if (_hx_tmp) {
HXLINE( 358)			if (!(::flixel::FlxG_obj::mouse->overlaps(::hx::ObjectPtr<OBJ_>(this),null()))) {
HXLINE( 360)				this->showList(false);
            			}
            		}
            	}
...
HXLINE( 419)		{
HXLINE( 419)			int _g = 0;
HXDLIN( 419)			int _g1 = StringArray->length;
