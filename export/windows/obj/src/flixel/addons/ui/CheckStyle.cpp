...
HX_DEFINE_STACK_FRAME(_hx_pos_b952e0391651718d_504_new,"flixel.addons.ui.CheckStyle","new",0xda9b8dcc,"flixel.addons.ui.CheckStyle.new","flixel/addons/ui/FlxUIRadioGroup.hx",504,0x807a4586)
HX_LOCAL_STACK_FRAME(_hx_pos_b952e0391651718d_512_applyToCheck,"flixel.addons.ui.CheckStyle","applyToCheck",0x906b6693,"flixel.addons.ui.CheckStyle.applyToCheck","flixel/addons/ui/FlxUIRadioGroup.hx",512,0x807a4586)
namespace flixel{
namespace addons{
namespace ui{
...
void CheckStyle_obj::__construct( ::Dynamic CheckColor, ::flixel::addons::ui::FontDef Font,::String Align, ::Dynamic Color, ::flixel::addons::ui::BorderDef Border){
            	HX_STACKFRAME(&_hx_pos_b952e0391651718d_504_new)
HXLINE( 505)		this->checkColor = null();
HXLINE( 508)		this->checkColor = CheckColor;
HXLINE( 509)		super::__construct(Font,Align,Color,Border);
            	}
...
void CheckStyle_obj::applyToCheck( ::flixel::addons::ui::FlxUICheckBox c){
            	HX_STACKFRAME(&_hx_pos_b952e0391651718d_512_applyToCheck)
HXLINE( 513)		if (::hx::IsNotNull( this->checkColor )) {
HXLINE( 514)			c->set_color(( (int)(this->checkColor) ));
            		}
HXLINE( 516)		this->apply(( ( ::flixel::text::FlxText)(c->button->label) ));
            	}
