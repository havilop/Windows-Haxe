...
HXLINE( 468)			this->background =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("flixel/flixel-ui/img/box.png",dd,a4,cf,5b), ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,Width,20),::Array_obj< int >::fromData( _hx_array_data_73217fd3_1,4),null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 472)		if (::hx::IsNull( this->button )) {
HXLINE( 473)			this->button =  ::flixel::addons::ui::FlxUISpriteButton_obj::__alloc( HX_CTX ,0,0, ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/dropdown_mark.png",cd,eb,34,3e)),null());
HXLINE( 474)			 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 474)			_hx_tmp->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),80,20,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07))),0,-1,false,18,18,null());
            		}
...
HXLINE( 482)		this->button->set_width(( (Float)(Width) ));
HXLINE( 483)		 ::flixel::addons::ui::FlxUISpriteButton fh = this->button;
HXDLIN( 483)		fh->offset->set_x((fh->offset->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 484)		this->button->set_x(this->offset->x);
HXLINE( 485)		 ::flixel::FlxSprite fh1 = ( ( ::flixel::FlxSprite)(this->button->label) );
HXDLIN( 485)		fh1->offset->set_x((fh1->offset->x + this->button->offset->x));
HXLINE( 488)		if (::hx::IsNull( this->text )) {
HXLINE( 489)			this->text =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,::Std_obj::_hx_int(this->background->get_width()),null(),null(),null());
            		}
HXLINE( 491)		this->text->setPosition(2,4);
HXLINE( 492)		this->text->set_color(-16777216);
