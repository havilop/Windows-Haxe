...
HX_LOCAL_STACK_FRAME(_hx_pos_75fddae7e64ce41a_294_update,"flixel.addons.ui.FlxInputText","update",0x954505a1,"flixel.addons.ui.FlxInputText.update","flixel/addons/ui/FlxInputText.hx",294,0x19fbd1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_75fddae7e64ce41a_439_getCaretIndex,"flixel.addons.ui.FlxInputText","getCaretIndex",0xfe00362d,"flixel.addons.ui.FlxInputText.getCaretIndex","flixel/addons/ui/FlxInputText.hx",439,0x19fbd1e7)
...
HXLINE( 151)		this->backgroundColor = -1;
HXLINE( 146)		this->fieldBorderThickness = 1;
HXLINE( 141)		this->fieldBorderColor = -16777216;
HXLINE( 136)		this->filterMode = 0;
HXLINE( 125)		this->maxLength = 0;
HXLINE( 119)		this->forceCase = 0;
HXLINE( 102)		this->caretIndex = 0;
HXLINE(  97)		this->hasFocus = false;
HXLINE(  79)		this->caretWidth = 1;
...
HXLINE( 201)		if ((BackgroundColor != 0)) {
...
HXDLIN( 210)		_hx_tmp->makeGraphic(_hx_tmp1,::Std_obj::_hx_int(( (Float)((size + 2)) )),null(),null(),null());
HXLINE( 211)		this->_caretTimer =  ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null());
HXLINE( 213)		this->set_caretIndex(0);
...
HXLINE( 220)		this->set_lines(1);
HXLINE( 221)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("keyDown",a1,69,47,9c),this->onKeyDown_dyn(),null(),null(),null());
...
HXLINE(  54)		this->set_filterMode(4);
...
HXLINE( 237)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("keyDown",a1,69,47,9c),this->onKeyDown_dyn(),null());
...
HXLINE( 246)			while((this->_charBoundaries->length > 0)){
...
HXDLIN( 268)			_hx_tmp = (_hx_tmp1 != (::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2));
            		}
            		else {
...
void FlxInputText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_75fddae7e64ce41a_294_update)
HXLINE( 295)		this->super::update(elapsed);
HXLINE( 299)		if ((::flixel::FlxG_obj::mouse->_leftButton->current == 2)) {
HXLINE( 301)			bool hadFocus = this->hasFocus;
HXLINE( 302)			if (::flixel::FlxG_obj::mouse->overlaps(::hx::ObjectPtr<OBJ_>(this),null())) {
HXLINE( 304)				this->set_caretIndex(this->getCaretIndex());
HXLINE( 305)				this->set_hasFocus(true);
HXLINE( 306)				bool _hx_tmp;
HXDLIN( 306)				if (!(hadFocus)) {
HXLINE( 306)					_hx_tmp = ::hx::IsNotNull( this->focusGained );
            				}
            				else {
HXLINE( 306)					_hx_tmp = false;
            				}
HXDLIN( 306)				if (_hx_tmp) {
HXLINE( 307)					this->focusGained();
            				}
            			}
            			else {
HXLINE( 311)				this->set_hasFocus(false);
HXLINE( 312)				bool _hx_tmp1;
HXDLIN( 312)				if (hadFocus) {
HXLINE( 312)					_hx_tmp1 = ::hx::IsNotNull( this->focusLost );
            				}
            				else {
HXLINE( 312)					_hx_tmp1 = false;
            				}
HXDLIN( 312)				if (_hx_tmp1) {
HXLINE( 313)					this->focusLost();
            				}
            			}
            		}
            	}
...
HXDLIN( 329)			if ((key != 16)) {
HXLINE( 329)				_hx_tmp2 = (key == 17);
            			}
            			else {
HXLINE( 329)				_hx_tmp2 = true;
            			}
HXDLIN( 329)			if (!(_hx_tmp2)) {
HXLINE( 329)				_hx_tmp1 = (key == 220);
            			}
            			else {
HXLINE( 329)				_hx_tmp1 = true;
            			}
HXDLIN( 329)			if (!(_hx_tmp1)) {
HXLINE( 329)				_hx_tmp = (key == 27);
            			}
            			else {
...
HXLINE( 334)				if ((key == 37)) {
HXLINE( 336)					if ((this->caretIndex > 0)) {
HXLINE( 337)						this->set_caretIndex((this->caretIndex - 1));
HXLINE( 338)						this->set_text(this->text);
            					}
            				}
            				else {
HXLINE( 342)					if ((key == 39)) {
HXLINE( 344)						if ((this->caretIndex < this->text.length)) {
HXLINE( 345)							this->set_caretIndex((this->caretIndex + 1));
HXLINE( 346)							this->set_text(this->text);
            						}
            					}
            					else {
HXLINE( 350)						if ((key == 35)) {
HXLINE( 352)							this->set_caretIndex(this->text.length);
HXLINE( 353)							this->set_text(this->text);
            						}
            						else {
HXLINE( 356)							if ((key == 36)) {
HXLINE( 358)								this->set_caretIndex(0);
HXLINE( 359)								this->set_text(this->text);
            							}
            							else {
HXLINE( 362)								if ((key == 8)) {
HXLINE( 364)									if ((this->caretIndex > 0)) {
HXLINE( 366)										this->set_caretIndex((this->caretIndex - 1));
HXLINE( 367)										::String _hx_tmp3 = this->text.substring(0,this->caretIndex);
HXDLIN( 367)										this->set_text((_hx_tmp3 + this->text.substring((this->caretIndex + 1),null())));
HXLINE( 368)										this->onChange(HX_("backspace",3f,85,ea,ca));
            									}
            								}
            								else {
HXLINE( 372)									if ((key == 46)) {
HXLINE( 374)										bool _hx_tmp4;
HXDLIN( 374)										if ((this->text.length > 0)) {
HXLINE( 374)											_hx_tmp4 = (this->caretIndex < this->text.length);
            										}
            										else {
HXLINE( 374)											_hx_tmp4 = false;
            										}
HXDLIN( 374)										if (_hx_tmp4) {
HXLINE( 376)											::String _hx_tmp5 = this->text.substring(0,this->caretIndex);
HXDLIN( 376)											this->set_text((_hx_tmp5 + this->text.substring((this->caretIndex + 1),null())));
HXLINE( 377)											this->onChange(HX_("delete",2b,c0,d8,6a));
            										}
            									}
            									else {
HXLINE( 381)										if ((key == 13)) {
HXLINE( 383)											this->onChange(HX_("enter",18,6d,86,70));
            										}
            										else {
HXLINE( 388)											if ((e->charCode == 0)) {
HXLINE( 390)												return;
            											}
HXLINE( 392)											::String newText = this->filter(::String::fromCharCode(e->charCode));
HXLINE( 394)											bool _hx_tmp6;
HXDLIN( 394)											if ((newText.length > 0)) {
HXLINE( 394)												if ((this->maxLength != 0)) {
HXLINE( 394)													_hx_tmp6 = ((this->text.length + newText.length) < this->maxLength);
            												}
            												else {
HXLINE( 394)													_hx_tmp6 = true;
            												}
            											}
            											else {
HXLINE( 394)												_hx_tmp6 = false;
            											}
...
HXLINE( 424)			::String Original1 = (Original.substring(0,Index) + Insert);
...
int FlxInputText_obj::getCaretIndex(){
            	HX_STACKFRAME(&_hx_pos_75fddae7e64ce41a_439_getCaretIndex)
HXLINE( 441)		Float x = (( (Float)(::flixel::FlxG_obj::mouse->x) ) - this->x);
HXDLIN( 441)		Float y = (( (Float)(::flixel::FlxG_obj::mouse->y) ) - this->y);
HXDLIN( 441)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 441)		point->_inPool = false;
HXDLIN( 441)		 ::flixel::math::FlxBasePoint hit = point;
HXLINE( 442)		return this->getCharIndexAtPoint(hit->x,hit->y);
            	}
...
HXLINE( 451)			_hx_tmp1 = (charIndex >= 0);
            		}
            		else {
HXLINE( 451)			_hx_tmp1 = false;
            		}
HXDLIN( 451)		if (_hx_tmp1) {
HXLINE( 451)			_hx_tmp = (this->_charBoundaries->length > 0);
            		}
            		else {
HXLINE( 451)			_hx_tmp = false;
            		}
HXDLIN( 451)		if (_hx_tmp) {
HXLINE( 453)			 ::openfl::geom::Rectangle r =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 454)			if ((charIndex >= this->_charBoundaries->length)) {
HXLINE( 456)				 ::flixel::math::FlxRect _this = this->_charBoundaries->__get((this->_charBoundaries->length - 1)).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 456)				 ::openfl::geom::Rectangle FlashRect = r;
HXDLIN( 456)				if (::hx::IsNull( FlashRect )) {
HXLINE( 456)					FlashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 456)				FlashRect->x = _this->x;
HXDLIN( 456)				FlashRect->y = _this->y;
HXDLIN( 456)				FlashRect->width = _this->width;
HXDLIN( 456)				FlashRect->height = _this->height;
            			}
            			else {
HXLINE( 459)				 ::flixel::math::FlxRect _this1 = this->_charBoundaries->__get(charIndex).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 459)				 ::openfl::geom::Rectangle FlashRect1 = r;
HXDLIN( 459)				if (::hx::IsNull( FlashRect1 )) {
HXLINE( 459)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 459)				FlashRect1->x = _this1->x;
HXDLIN( 459)				FlashRect1->y = _this1->y;
HXDLIN( 459)				FlashRect1->width = _this1->width;
HXDLIN( 459)				FlashRect1->height = _this1->height;
            			}
HXLINE( 461)			return r;
            		}
...
HXLINE( 484)		Float textH = ( (Float)(0) );
HXLINE( 485)		Float textW = ( (Float)(0) );
HXLINE( 486)		Float lastW = ( (Float)(0) );
HXLINE( 491)		Float magicX = ( (Float)(2) );
HXLINE( 492)		Float magicY = ( (Float)(2) );
HXLINE( 494)		{
HXLINE( 494)			int _g = 0;
HXDLIN( 494)			int _g1 = numChars;
HXDLIN( 494)			while((_g < _g1)){
HXLINE( 494)				_g = (_g + 1);
HXDLIN( 494)				int i = (_g - 1);
HXLINE( 496)				 ::openfl::text::TextField _hx_tmp = this->textField;
HXDLIN( 496)				_hx_tmp->appendText(Text.substr(i,1));
...
HXLINE( 515)		int i = 0;
HXLINE( 517)		X = (X + (this->textField->get_scrollH() + 2));
HXLINE( 521)		bool _hx_tmp;
HXDLIN( 521)		if (::hx::IsNotNull( this->_charBoundaries )) {
HXLINE( 521)			_hx_tmp = (this->_charBoundaries->length > 0);
            		}
            		else {
...
HXLINE( 524)				::String _hx_switch_0 = this->getAlignStr();
            				if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 529)					Float X1 = (X - (this->textField->get_width() / ( (Float)(2) )));
HXDLIN( 529)					X = (X1 + (this->textField->get_textWidth() / ( (Float)(2) )));
...
HXLINE( 538)			int _g = 0;
HXDLIN( 538)			::Array< ::Dynamic> _g1 = this->_charBoundaries;
HXDLIN( 538)			while((_g < _g1->length)){
HXLINE( 538)				 ::flixel::math::FlxRect r = _g1->__get(_g).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 538)				_g = (_g + 1);
...
HXLINE( 549)			_hx_tmp3 = (this->_charBoundaries->length > 0);
            		}
            		else {
...
HXDLIN( 577)			int _g3 = numChars;
HXDLIN( 577)			while((_g2 < _g3)){
HXLINE( 577)				_g2 = (_g2 + 1);
HXDLIN( 577)				int i1 = (_g2 - 1);
HXLINE( 579)				if (((this->_charBoundaries->length - 1) < i1)) {
HXLINE( 581)					::Array< ::Dynamic> _hx_tmp = this->_charBoundaries;
HXDLIN( 581)					 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 581)					_this->x = ( (Float)(0) );
HXDLIN( 581)					_this->y = ( (Float)(0) );
HXDLIN( 581)					_this->width = ( (Float)(0) );
HXDLIN( 581)					_this->height = ( (Float)(0) );
...
HXLINE( 591)		 ::openfl::geom::Rectangle boundary = null();
HXLINE( 592)		if ((this->caretIndex == -1)) {
HXLINE( 594)			boundary = this->getCharBoundaries((this->text.length - 1));
            		}
            		else {
HXLINE( 597)			boundary = this->getCharBoundaries(this->caretIndex);
            		}
HXLINE( 600)		if (::hx::IsNotNull( boundary )) {
HXLINE( 603)			int diffW = 0;
HXLINE( 604)			Float _hx_tmp = boundary->get_right();
HXDLIN( 604)			int _hx_tmp1 = this->lastScroll;
HXDLIN( 604)			if ((_hx_tmp > ((_hx_tmp1 + this->textField->get_width()) - ( (Float)(2) )))) {
HXLINE( 606)				Float diffW1 = (this->textField->get_width() - ( (Float)(2) ));
...
HXLINE( 609)					diffW = (::Std_obj::_hx_int(boundary->get_left()) - 2);
            				}
            				else {
...
HXLINE( 634)			if ((this->fieldBorderThickness > 0)) {
HXLINE( 636)				 ::flixel::FlxSprite _hx_tmp = this->fieldBorderSprite;
HXDLIN( 636)				Float _hx_tmp1 = this->get_width();
HXDLIN( 636)				int _hx_tmp2 = ::Std_obj::_hx_int((_hx_tmp1 + (this->fieldBorderThickness * 2)));
HXDLIN( 636)				Float _hx_tmp3 = this->get_height();
HXDLIN( 636)				int _hx_tmp4 = ::Std_obj::_hx_int((_hx_tmp3 + (this->fieldBorderThickness * 2)));
HXDLIN( 636)				_hx_tmp->makeGraphic(_hx_tmp2,_hx_tmp4,this->fieldBorderColor,null(),null());
HXLINE( 637)				this->fieldBorderSprite->set_x((this->x - ( (Float)(this->fieldBorderThickness) )));
HXLINE( 638)				this->fieldBorderSprite->set_y((this->y - ( (Float)(this->fieldBorderThickness) )));
            			}
            			else {
HXLINE( 640)				if ((this->fieldBorderThickness == 0)) {
...
HXLINE( 650)				 ::flixel::FlxSprite _hx_tmp5 = this->backgroundSprite;
HXDLIN( 650)				int _hx_tmp6 = ::Std_obj::_hx_int(this->get_width());
HXDLIN( 650)				int _hx_tmp7 = ::Std_obj::_hx_int(this->get_height());
HXDLIN( 650)				_hx_tmp5->makeGraphic(_hx_tmp6,_hx_tmp7,this->backgroundColor,null(),null());
...
HXLINE( 666)			int ch = ::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) ));
HXLINE( 669)			int borderC = (-16777216 | (this->borderColor & 16777215));
HXLINE( 670)			int caretC = (-16777216 | (this->caretColor & 16777215));
...
HXLINE( 674)			switch((int)(this->borderStyle->_hx_getIndex())){
            				case (int)0: {
HXLINE( 678)					this->caret->makeGraphic(cw,ch,caretC,false,caretKey1);
HXLINE( 679)					{
HXLINE( 679)						 ::flixel::math::FlxBasePoint this1 = this->caret->offset;
HXDLIN( 679)						this1->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
            				case (int)1: {
...
HXLINE( 685)					this->caret->makeGraphic(cw,ch,0,false,caretKey1);
HXLINE( 686)					Float r = this->borderSize;
HXDLIN( 686)					Float r1 = this->borderSize;
HXDLIN( 686)					int r2 = this->caretWidth;
HXDLIN( 686)					 ::openfl::geom::Rectangle r3 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r,r1,r2,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
HXLINE( 687)					this->caret->get_pixels()->fillRect(r3,borderC);
HXLINE( 688)					r3->x = (r3->y = ( (Float)(0) ));
HXLINE( 689)					this->caret->get_pixels()->fillRect(r3,caretC);
HXLINE( 690)					{
HXLINE( 690)						 ::flixel::math::FlxBasePoint this2 = this->caret->offset;
HXDLIN( 690)						this2->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
            				case (int)2: case (int)3: {
HXLINE( 694)					cw = (cw + ::Std_obj::_hx_int((this->borderSize * ( (Float)(2) ))));
HXLINE( 695)					ch = (ch + ::Std_obj::_hx_int((this->borderSize * ( (Float)(2) ))));
...
HXDLIN( 697)					 ::openfl::geom::Rectangle r7 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
HXLINE( 698)					this->caret->get_pixels()->fillRect(r7,caretC);
HXLINE( 700)					{
HXLINE( 700)						 ::flixel::math::FlxBasePoint this3 = this->caret->offset;
HXDLIN( 700)						this3->set_x(this->caret->offset->set_y(this->borderSize));
            					}
            				}
            				break;
            			}
HXLINE( 703)			this->caret->set_width(( (Float)(cw) ));
HXLINE( 704)			this->caret->set_height(( (Float)(ch) ));
...
HXLINE( 724)		if ((this->forceCase == 1)) {
HXLINE( 726)			text = text.toUpperCase();
            		}
            		else {
HXLINE( 728)			if ((this->forceCase == 2)) {
HXLINE( 730)				text = text.toLowerCase();
            			}
            		}
HXLINE( 733)		if ((this->filterMode != 0)) {
HXLINE( 735)			 ::EReg pattern;
HXLINE( 736)			switch((int)(this->filterMode)){
            				case (int)1: {
...
HXLINE( 764)			_hx_tmp = (this->fieldBorderThickness > 0);
            		}
            		else {
HXLINE( 764)			_hx_tmp = false;
            		}
HXDLIN( 764)		if (_hx_tmp) {
HXLINE( 766)			this->fieldBorderSprite->set_x((X - ( (Float)(this->fieldBorderThickness) )));
            		}
HXLINE( 768)		bool _hx_tmp1;
HXDLIN( 768)		if (::hx::IsNotNull( this->backgroundSprite )) {
HXLINE( 768)			_hx_tmp1 = this->background;
            		}
            		else {
...
HXLINE( 777)			_hx_tmp = (this->fieldBorderThickness > 0);
            		}
            		else {
HXLINE( 777)			_hx_tmp = false;
            		}
HXDLIN( 777)		if (_hx_tmp) {
HXLINE( 779)			this->fieldBorderSprite->set_y((Y - ( (Float)(this->fieldBorderThickness) )));
            		}
HXLINE( 781)		bool _hx_tmp1;
HXDLIN( 781)		if (::hx::IsNotNull( this->backgroundSprite )) {
HXLINE( 781)			_hx_tmp1 = this->background;
            		}
            		else {
...
HXLINE( 794)				this->_caretTimer =  ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.5),this->toggleCaret_dyn(),0);
...
HXLINE( 826)		Float offx = ( (Float)(0) );
HXLINE( 828)		::String alignStr = this->getAlignStr();
HXLINE( 830)		::String _hx_switch_0 = alignStr;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 837)			Float offx1 = (this->textField->get_width() - ( (Float)(2) ));
HXDLIN( 837)			Float offx2 = ((offx1 - this->textField->get_textWidth()) / ( (Float)(2) ));
HXDLIN( 837)			offx = (offx2 + (( (Float)(this->textField->get_scrollH()) ) / ( (Float)(2) )));
HXLINE( 839)			if ((offx <= 1)) {
HXLINE( 839)				offx = ( (Float)(0) );
            			}
HXLINE( 835)			goto _hx_goto_31;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 832)			Float offx3 = (this->textField->get_width() - ( (Float)(2) ));
HXDLIN( 832)			offx = ((offx3 - this->textField->get_textWidth()) - ( (Float)(2) ));
HXLINE( 833)			if ((offx < 0)) {
HXLINE( 833)				offx = ( (Float)(0) );
            			}
HXLINE( 831)			goto _hx_goto_31;
            		}
            		/* default */{
HXLINE( 841)			offx = ( (Float)(0) );
            		}
            		_hx_goto_31:;
HXLINE( 844)		this->caretIndex = newCaretIndex;
HXLINE( 847)		if ((this->caretIndex > (this->text.length + 1))) {
HXLINE( 849)			this->caretIndex = -1;
            		}
HXLINE( 853)		if ((this->caretIndex != -1)) {
HXLINE( 855)			 ::openfl::geom::Rectangle boundaries = null();
...
HXLINE( 862)					 ::flixel::FlxSprite _hx_tmp = this->caret;
HXDLIN( 862)					Float _hx_tmp1 = (offx + boundaries->get_left());
HXDLIN( 862)					_hx_tmp->set_x((_hx_tmp1 + this->x));
HXLINE( 863)					 ::flixel::FlxSprite _hx_tmp2 = this->caret;
HXDLIN( 863)					Float _hx_tmp3 = boundaries->get_top();
HXDLIN( 863)					_hx_tmp2->set_y((_hx_tmp3 + this->y));
            				}
            			}
            			else {
HXLINE( 868)				boundaries = this->getCharBoundaries((this->caretIndex - 1));
HXLINE( 869)				if (::hx::IsNotNull( boundaries )) {
HXLINE( 871)					 ::flixel::FlxSprite _hx_tmp4 = this->caret;
HXDLIN( 871)					Float _hx_tmp5 = (offx + boundaries->get_right());
HXDLIN( 871)					_hx_tmp4->set_x((_hx_tmp5 + this->x));
HXLINE( 872)					 ::flixel::FlxSprite _hx_tmp6 = this->caret;
HXDLIN( 872)					Float _hx_tmp7 = boundaries->get_top();
HXDLIN( 872)					_hx_tmp6->set_y((_hx_tmp7 + this->y));
            				}
            				else {
HXLINE( 875)					if ((this->text.length == 0)) {
HXLINE( 878)						this->caret->set_x(((this->x + offx) + 2));
HXLINE( 879)						this->caret->set_y((this->y + 2));
            					}
            				}
            			}
            		}
HXLINE( 885)		 ::flixel::FlxSprite fh = this->caret;
HXDLIN( 885)		Float fh1 = fh->x;
HXDLIN( 885)		fh->set_x((fh1 - ( (Float)(this->textField->get_scrollH()) )));
HXLINE( 889)		bool _hx_tmp8;
HXDLIN( 889)		if ((this->lines == 1)) {
HXLINE( 889)			Float _hx_tmp9 = this->caret->x;
HXDLIN( 889)			Float _hx_tmp10 = (_hx_tmp9 + this->caret->get_width());
HXDLIN( 889)			Float _hx_tmp11 = this->x;
HXDLIN( 889)			_hx_tmp8 = (_hx_tmp10 > (_hx_tmp11 + this->get_width()));
            		}
            		else {
HXLINE( 889)			_hx_tmp8 = false;
            		}
HXDLIN( 889)		if (_hx_tmp8) {
HXLINE( 891)			 ::flixel::FlxSprite _hx_tmp12 = this->caret;
HXDLIN( 891)			Float _hx_tmp13 = this->x;
HXDLIN( 891)			_hx_tmp12->set_x(((_hx_tmp13 + this->get_width()) - ( (Float)(2) )));
            		}
...
HXDLIN( 907)		_hx_tmp->makeGraphic(1,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )),null(),null(),null());
...
HXLINE( 916)			this->set_text(this->text.substring(0,this->maxLength));
            		}
...
HXLINE( 923)		if ((Value == 0)) {
HXLINE( 923)			return 0;
            		}
HXLINE( 925)		if ((Value > 1)) {
