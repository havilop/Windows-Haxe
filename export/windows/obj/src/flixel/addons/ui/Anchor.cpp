...
HXLINE(  34)		Float destX = ( (Float)(0) );
HXLINE(  35)		Float destY = ( (Float)(0) );
HXLINE(  37)		::String _hx_switch_0 = this->x->side;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(  41)			Float destination1 = destination->x;
HXDLIN(  41)			destX = (destination1 + (destination->get_width() / ( (Float)(2) )));
...
HXLINE(  42)			destX = destination->x;
            		...
            		_hx_goto_2:;
HXLINE(  44)		::String _hx_switch_1 = this->y->side;
...
HXDLIN(  48)			destY = (destination4 + (destination->get_height() / ( (Float)(2) )));
...
HXLINE(  49)			destY = destination->y;
            		...
            		_hx_goto_3:;
HXLINE(  51)		::String _hx_switch_2 = this->x->flush;
            		if (  (_hx_switch_2==HX_("center",d5,25,db,05)) ){
HXLINE(  55)			destX = (destX - (thing->get_width() / ( (Float)(2) )));
...
HXDLIN(  54)			goto _hx_goto_4;
            		...
            		_hx_goto_4:;
HXLINE(  58)		::String _hx_switch_3 = this->y->flush;
...
HXLINE(  62)			destY = (destY - (thing->get_height() / ( (Float)(2) )));
...
HXDLIN(  71)		if (FlipX) {
HXLINE(  71)			xoff = (( (Float)(-1) ) * this->x->offset);
            		}
            		else {
...
HXDLIN(  72)		if (FlipY) {
HXLINE(  72)			yoff = (( (Float)(-1) ) * this->y->offset);
            		}
            		else {
