...
HXLINE(  58)		this->set_color(( (int)(Color) ));
HXLINE(  59)		if (::hx::IsNotNull( Label )) {
HXLINE(  62)			this->set_label( ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,80,Label,8,null()));
HXLINE(  63)			( ( ::flixel::text::FlxText)(this->label) )->setFormat(null(),8,3355443,HX_("center",d5,25,db,05),null(),null(),null());
            		}
HXLINE(  66)		if (( (bool)(LoadBlank) )) {
HXLINE(  68)			this->_no_graphic = true;
            		}
HXLINE(  71)		if (( (bool)(LoadDefaultGraphics) )) {
...
HXLINE( 107)		if (::hx::IsNotNull( this->label )) {
...
HXDLIN( 129)		if (::hx::IsNull( this->label )) {
HXLINE( 129)			newButton = null();
            		}
            		else {
HXLINE( 129)			newButton = ( ( ::flixel::text::FlxText)(this->label) )->text;
            		}
HXDLIN( 129)		 ::flixel::addons::ui::FlxUIButton newButton1 =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,newButton,this->onUp->callback,false,null(),null());
...
HXLINE( 137)		if (::Std_obj::isOfType(other,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >()) ))) {
...
HXLINE( 150)			 ::openfl::text::TextFormat tf = t->textField->get_defaultTextFormat();
HXLINE( 152)			if ((t->_font.indexOf(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,null()) == -1)) {
...
HXDLIN( 162)				int _hx_tmp1 = ::Std_obj::_hx_int(( (Float)(tf->size) ));
HXDLIN( 162)				 ::Dynamic tf1 = tf->color;
HXDLIN( 162)				 ::flixel::text::FlxTextBorderStyle t1 = t->borderStyle;
HXDLIN( 162)				int t2 = t->borderColor;
HXDLIN( 162)				_hx_tmp->setFormat(null(),_hx_tmp1,tf1,flxAlign,t1,t2,t->textField->get_embedFonts());
            			}
            		}
            	}
...
HXLINE( 185)		 ::openfl::display::BitmapData newBmp = this->_noIconGraphicsBkup->clone();
...
HXLINE( 194)		int sx = X;
HXLINE( 195)		int sy = Y;
HXLINE( 197)		if (( (bool)(center) )) {
HXLINE( 198)			Float sx1 = this->get_width();
HXDLIN( 198)			sx = ::Std_obj::_hx_int(((sx1 - icon->get_width()) / ( (Float)(2) )));
HXLINE( 199)			Float sy1 = this->get_height();
HXDLIN( 199)			sy = ::Std_obj::_hx_int(((sy1 - icon->get_height()) / ( (Float)(2) )));
            		}
HXLINE( 203)		{
HXLINE( 203)			int _g = 0;
HXDLIN( 203)			int _g1 = this->get_numFrames();
HXDLIN( 203)			while((_g < _g1)){
HXLINE( 203)				_g = (_g + 1);
HXDLIN( 203)				int i = (_g - 1);
HXLINE( 205)				int _hx_tmp1;
HXDLIN( 205)				if ((i > 2)) {
HXLINE( 205)					_hx_tmp1 = 2;
            				}
            				else {
HXLINE( 205)					_hx_tmp1 = i;
            				}
HXDLIN( 205)				int _hx_tmp2 = (sx + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp1).StaticCast<  ::flixel::math::FlxBasePoint >()->x));
HXDLIN( 205)				int _hx_tmp3 = (sy + ::Std_obj::_hx_int((( (Float)(i) ) * this->get_height())));
HXDLIN( 205)				int _hx_tmp4;
HXDLIN( 205)				if ((i > 2)) {
HXLINE( 205)					_hx_tmp4 = 2;
            				}
            				else {
HXLINE( 205)					_hx_tmp4 = i;
            				}
HXDLIN( 205)				this->stamp(icon,_hx_tmp2,(_hx_tmp3 + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp4).StaticCast<  ::flixel::math::FlxBasePoint >()->y)));
            			}
            		}
            	}
...
HXLINE( 214)			this->graphic->bitmap->fillRect(this->graphic->bitmap->rect,0);
HXLINE( 215)			 ::openfl::display::BitmapData _hx_tmp = this->graphic->bitmap;
HXDLIN( 215)			 ::openfl::display::BitmapData _hx_tmp1 = this->_noIconGraphicsBkup;
HXDLIN( 215)			 ::openfl::geom::Rectangle _hx_tmp2 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->_noIconGraphicsBkup->width,this->_noIconGraphicsBkup->height);
HXDLIN( 215)			_hx_tmp->copyPixels(_hx_tmp1,_hx_tmp2, ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()),null(),null(),null());
...
HXLINE( 250)		if (::hx::IsNotNull( this->label )) {
...
HXDLIN( 252)			_hx_tmp->set_width(( (Float)((( ( ::flixel::FlxSprite)(this->label) )->frameWidth = ::Std_obj::_hx_int(_hx_tmp1))) ));
...
HXDLIN( 254)			_hx_tmp3->set_size(::Std_obj::_hx_int(( (Float)(( ( ::flixel::text::FlxText)(this->label) )->_defaultFormat->size) )));
            		}
            	}
...
HXLINE( 261)		if (::hx::IsNotNull( this->label )) {
...
HXLINE( 263)				( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->down_toggle_style->color) ));
...
HXLINE( 271)					( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->down_style->color) ));
...
HXLINE( 285)		if (::hx::IsNotNull( this->label )) {
...
HXLINE( 287)				( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->over_toggle_style->color) ));
...
HXLINE( 295)					( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->over_style->color) ));
...
HXLINE( 311)				( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->up_toggle_style->color) ));
...
HXLINE( 319)					( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->up_style->color) ));
...
HXLINE( 335)				( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->up_toggle_style->color) ));
...
HXLINE( 343)					( ( ::flixel::text::FlxText)(this->label) )->set_color(( (int)(this->up_style->color) ));
