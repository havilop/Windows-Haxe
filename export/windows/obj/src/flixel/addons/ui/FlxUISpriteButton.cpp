...
HXDLIN(  48)		if (::hx::IsNotNull( this->label )) {
HXLINE(  49)			if (::Std_obj::isOfType(this->label,( ( ::Dynamic)(::hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >()) ))) {
...
HXDLIN(  51)						_g = (_g + 1);
HXLINE(  52)						sprite->set_x((-(sprite->get_width()) / ( (Float)(2) )));
HXLINE(  53)						sprite->set_y((-(sprite->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE(  61)				{
HXLINE(  61)					int _g2 = 0;
HXDLIN(  61)					::Array< ::Dynamic> _g3 = g->group->members;
HXDLIN(  61)					while((_g2 < _g3->length)){
HXLINE(  61)						 ::flixel::FlxSprite sprite1 = _g3->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  61)						_g2 = (_g2 + 1);
HXLINE(  62)						sprite1->set_x(((W - sprite1->get_width()) / ( (Float)(2) )));
HXLINE(  63)						sprite1->set_y(((H - sprite1->get_height()) / ( (Float)(2) )));
            					}
            				}
            			}
