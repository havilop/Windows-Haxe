...
HXLINE( 635)		this->lastMouseY = ((Float)0);
HXLINE( 634)		this->lastMouseX = ((Float)0);
HXLINE( 220)		this->inputMethod = 0;
...
HXLINE( 238)			if ((::flixel::FlxG_obj::height < 400)) {
...
HXLINE( 245)		super::__construct(0,0,Asset);
...
HXLINE( 249)		this->_widgets = ( (::Array< ::Dynamic>)(this->_lists->__get(0)->__Field(HX_("widgets",2f,1c,67,28),::hx::paccDynamic)) );
HXLINE( 250)		this->anchor =  ::flixel::addons::ui::Anchor_obj::__alloc( HX_CTX ,( (Float)(-2) ),( (Float)(0) ),HX_("left",07,08,b0,47),HX_("center",d5,25,db,05),HX_("right",dc,0b,64,e9),HX_("center",d5,25,db,05));
HXLINE( 251)		this->setDefaultKeys(DefaultKeys);
HXLINE( 252)		this->callback = Callback;
HXLINE( 254)		{
HXLINE( 254)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
HXDLIN( 254)			this1->set_x(( (Float)(0) ));
HXDLIN( 254)			this1->set_y(( (Float)(0) ));
            		}
HXLINE( 257)		bool _hx_tmp;
HXDLIN( 257)		if (::hx::IsNotNull( ::flixel::FlxG_obj::mouse )) {
HXLINE( 257)			_hx_tmp = (::Std_obj::isOfType(::flixel::FlxG_obj::mouse,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIMouse >()) )) == false);
            		}
            		else {
HXLINE( 257)			_hx_tmp = false;
            		}
HXDLIN( 257)		if (_hx_tmp) {
HXLINE( 259)			this->_newMouse =  ::flixel::addons::ui::FlxUIMouse_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::mouse->cursorContainer);
HXLINE( 260)			::flixel::FlxG_obj::set_mouse(this->_newMouse);
            		}
            		else {
HXLINE( 264)			this->_newMouse = ( ( ::flixel::addons::ui::FlxUIMouse)(::flixel::FlxG_obj::mouse) );
            		}
            	}
...
HXLINE(  53)				_hx_tmp = ::hx::IsEq( this->_widgets->__get(this->location)->__Field(HX_("visible",72,78,24,a3),::hx::paccDynamic),false );
            			}
            			else {
...
HXLINE(  57)				if ((this->location == (this->_widgets->length - 1))) {
HXLINE(  59)					if (wrap) {
HXLINE(  61)						if (!(wrapped)) {
HXLINE(  63)							wrapped = true;
HXLINE(  64)							this->set_location(0);
            						}
            						else {
HXLINE(  68)							this->set_location(-1);
HXLINE(  69)							return;
            						}
            					}
            					else {
HXLINE(  74)						this->set_location(-1);
HXLINE(  75)						return;
            					}
            				}
            				else {
HXLINE(  80)					this->set_location((this->location + 1));
            				}
            			}
            			else {
HXLINE(  85)				if ((this->location == 0)) {
HXLINE(  87)					if (wrap) {
HXLINE(  89)						if (!(wrapped)) {
HXLINE(  91)							wrapped = true;
HXLINE(  92)							this->set_location((this->_widgets->length - 1));
            						}
            						else {
HXLINE(  96)							this->set_location(-1);
HXLINE(  97)							return;
            						}
            					}
            					else {
HXLINE( 102)						this->set_location(-1);
HXLINE( 103)						return;
            					}
            				}
            				else {
HXLINE( 108)					this->set_location((this->location - 1));
            				}
            			}
            		}
            		_hx_goto_1:;
...
HXLINE( 120)			_hx_tmp1 = (this->location >= 0);
            		}
            		else {
...
HXLINE( 131)			i = (this->_lists->length - 1);
            		}
            		else {
HXLINE( 133)			if ((i < 0)) {
HXLINE( 135)				i = 0;
...
HXLINE( 138)		this->set_location(0);
...
HXLINE( 153)			i = (this->_widgets->length - 1);
            		}
...
HXLINE( 176)						if (::Std_obj::isOfType(keys,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxMultiGamepad >()) ))) {
...
HXLINE( 273)		if (::hx::IsInstanceEq( ::flixel::FlxG_obj::mouse,this->_newMouse )) {
HXLINE( 276)			this->_newMouse = null();
            		}
...
HXDLIN( 310)		if ((this->lastMouseX == ::flixel::FlxG_obj::mouse->x)) {
HXLINE( 310)			_hx_tmp = (this->lastMouseY != ::flixel::FlxG_obj::mouse->y);
            		}
            		else {
HXLINE( 310)			_hx_tmp = true;
            		}
HXDLIN( 310)		if (_hx_tmp) {
HXLINE( 312)			bool oldVis = this->visible;
HXLINE( 313)			this->jumpToXY(( (Float)(::flixel::FlxG_obj::mouse->x) ),( (Float)(::flixel::FlxG_obj::mouse->y) ));
HXLINE( 314)			this->set_visible(oldVis);
HXLINE( 317)			this->lastMouseX = ( (Float)(::flixel::FlxG_obj::mouse->x) );
HXLINE( 318)			this->lastMouseY = ( (Float)(::flixel::FlxG_obj::mouse->y) );
            		}
HXLINE( 323)		this->_checkKeys();
HXLINE( 324)		 ::flixel::addons::ui::FlxUICursor _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 324)		_hx_tmp1->_clickTime = (_hx_tmp1->_clickTime + elapsed);
...
HXLINE( 336)			this->_widgets = ( (::Array< ::Dynamic>)(this->_lists->__get(0)->__Field(HX_("widgets",2f,1c,67,28),::hx::paccDynamic)) );
HXLINE( 337)			this->set_location(0);
HXLINE( 338)			this->set_listIndex(0);
            		}
            		else {
HXLINE( 342)			int _g2 = 0;
HXDLIN( 342)			::Array< ::Dynamic> _g3 = ui->group->members;
HXDLIN( 342)			while((_g2 < _g3->length)){
HXLINE( 342)				 ::flixel::FlxSprite widget = _g3->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 342)				_g2 = (_g2 + 1);
HXLINE( 344)				bool _hx_tmp;
HXDLIN( 344)				if (!(::Std_obj::isOfType(widget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::interfaces::ICursorPointable >()) )))) {
HXLINE( 344)					_hx_tmp = ::Std_obj::isOfType(widget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIGroup >()) ));
            				}
            				else {
...
HXLINE( 392)		int listi = 0;
HXLINE( 394)		Float bestd2 = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 395)		int bestli = -1;
HXLINE( 396)		int besti = -1;
...
HXDLIN( 402)						int _g3 = ( (::Array< ::Dynamic>)(list->__Field(HX_("widgets",2f,1c,67,28),::hx::paccDynamic)) )->length;
...
HXDLIN( 404)							if (::hx::IsEq( w->__Field(HX_("visible",72,78,24,a3),::hx::paccDynamic),true )) {
HXLINE( 404)								_hx_tmp3 = ::hx::IsGreaterEq( X,w->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) );
            							}
            							else {
HXLINE( 404)								_hx_tmp3 = false;
            							}
HXDLIN( 404)							if (_hx_tmp3) {
HXLINE( 404)								_hx_tmp2 = ::hx::IsGreaterEq( Y,w->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) );
            							}
            							else {
...
HXDLIN( 406)								Float dx = ((w3 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(w) / ( (Float)(2) ))) - X);
HXLINE( 407)								Float w4 = ( (Float)(w->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 407)								Float dy = ((w4 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(w) / ( (Float)(2) ))) - Y);
...
HXLINE( 416)					listi = (listi + 1);
            				}
            			}
HXLINE( 418)			bool _hx_tmp4;
HXDLIN( 418)			if ((bestli != -1)) {
HXLINE( 418)				_hx_tmp4 = (besti != -1);
            			}
            			else {
...
HXDLIN( 426)				int _g5 = this->_widgets->length;
HXDLIN( 426)				while((_g4 < _g5)){
HXLINE( 426)					_g4 = (_g4 + 1);
HXDLIN( 426)					int i1 = (_g4 - 1);
...
HXDLIN( 428)					if (::hx::IsEq( w5->__Field(HX_("visible",72,78,24,a3),::hx::paccDynamic),true )) {
HXLINE( 428)						_hx_tmp8 = ::hx::IsGreaterEq( X,w5->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) );
            					}
            					else {
HXLINE( 428)						_hx_tmp8 = false;
            					}
HXDLIN( 428)					if (_hx_tmp8) {
HXLINE( 428)						_hx_tmp7 = ::hx::IsGreaterEq( Y,w5->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) );
            					}
            					else {
...
HXDLIN( 430)						Float dx1 = ((w8 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(w5) / ( (Float)(2) ))) - X);
HXLINE( 431)						Float w9 = ( (Float)(w5->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 431)						Float dy1 = ((w9 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(w5) / ( (Float)(2) ))) - Y);
...
HXDLIN( 462)				_g2 = (_g2 + 1);
HXLINE( 464)				if (::hx::IsLess( w->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),x1 )) {
HXLINE( 464)					x1 = ( (Float)(w->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
            				}
HXLINE( 465)				if (::hx::IsLess( w->__Field(HX_("y",79,00,00,00),::hx::paccDynamic),y1 )) {
...
HXDLIN( 471)		if ((this->_lists->length == 1)) {
HXLINE( 471)			_hx_tmp1 = ::hx::IsNotNull( this->_lists->__get(0)->__Field(HX_("widgets",2f,1c,67,28),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 471)			_hx_tmp1 = false;
            		}
HXDLIN( 471)		if (_hx_tmp1) {
HXLINE( 471)			_hx_tmp = (( (::Array< ::Dynamic>)(this->_lists->__get(0)->__Field(HX_("widgets",2f,1c,67,28),::hx::paccDynamic)) )->length == 0);
            		}
            		else {
HXLINE( 471)			_hx_tmp = false;
            		}
HXDLIN( 471)		if (_hx_tmp) {
HXLINE( 473)			this->_lists->__get(0)->__SetField(HX_("widgets",2f,1c,67,28),::Array_obj< ::Dynamic>::__new(0),::hx::paccDynamic);
HXLINE( 474)			this->_lists->__get(0)->__SetField(HX_("x",78,00,00,00),::Std_obj::_hx_int(x1),::hx::paccDynamic);
HXLINE( 475)			this->_lists->__get(0)->__SetField(HX_("y",79,00,00,00),::Std_obj::_hx_int(y1),::hx::paccDynamic);
HXLINE( 476)			this->_lists->__get(0)->__SetField(HX_("width",06,b6,62,ca),::Std_obj::_hx_int((x2 - x1)),::hx::paccDynamic);
HXLINE( 477)			this->_lists->__get(0)->__SetField(HX_("height",e7,07,4c,02),::Std_obj::_hx_int((y2 - y1)),::hx::paccDynamic);
HXLINE( 478)			theList = this->_lists->__get(0);
            		}
            		else {
...
HXDLIN( 482)			_hx_tmp2->push( ::Dynamic(::hx::Anon_obj::Create(5)
            				...
            				->setFixed(4,HX_("widgets",2f,1c,67,28),::Array_obj< ::Dynamic>::__new(0))));
HXLINE( 483)			theList = this->_lists->__get((this->_lists->length - 1));
            		}
...
HXDLIN( 495)			::Array< ::Dynamic> _g5 = this->_lists;
HXDLIN( 495)			while((_g4 < _g5->length)){
HXLINE( 495)				 ::Dynamic widgetList = _g5->__get(_g4);
HXDLIN( 495)				_g4 = (_g4 + 1);
...
HXLINE( 503)		if (::Std_obj::isOfType(widget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::interfaces::ICursorPointable >()) ))) {
HXLINE( 505)			this->_widgets->push(widget);
            		}
            		else {
HXLINE( 507)			if (::Std_obj::isOfType(widget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIGroup >()) ))) {
...
HXDLIN( 510)						_g = (_g + 1);
HXLINE( 512)						if (::Std_obj::isOfType(member,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::interfaces::IFlxUIWidget >()) ))) {
...
HXLINE( 527)		switch((int)(method->_hx_getIndex())){
            			case (int)0: {
...
HXLINE( 548)			if ((list->indexOf(widget,null()) != -1)) {
...
HXLINE( 565)		if (((code & 1) == 1)) {
HXLINE( 566)			::Array< ::Dynamic> _hx_tmp = this->keysRight;
HXDLIN( 566)			this->_addToKeys(_hx_tmp, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,9,null(),::Array_obj< int >::fromData( _hx_array_data_79a4790b_34,1)));
HXLINE( 567)			::Array< ::Dynamic> _hx_tmp1 = this->keysLeft;
HXDLIN( 567)			this->_addToKeys(_hx_tmp1, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,9,::Array_obj< int >::fromData( _hx_array_data_79a4790b_35,1),null()));
HXLINE( 568)			::Array< ::Dynamic> _hx_tmp2 = this->keysClick;
HXDLIN( 568)			this->_addToKeys(_hx_tmp2, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,13,null(),null()));
            		}
HXLINE( 570)		if (((code & 256) == 256)) {
HXLINE( 571)			::Array< ::Dynamic> _hx_tmp3 = this->keysRight;
HXDLIN( 571)			this->_addToKeys(_hx_tmp3, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,39,null(),null()));
HXLINE( 572)			::Array< ::Dynamic> _hx_tmp4 = this->keysLeft;
HXDLIN( 572)			this->_addToKeys(_hx_tmp4, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,37,null(),null()));
HXLINE( 573)			::Array< ::Dynamic> _hx_tmp5 = this->keysDown;
HXDLIN( 573)			this->_addToKeys(_hx_tmp5, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,40,null(),null()));
HXLINE( 574)			::Array< ::Dynamic> _hx_tmp6 = this->keysUp;
HXDLIN( 574)			this->_addToKeys(_hx_tmp6, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,38,null(),null()));
HXLINE( 575)			::Array< ::Dynamic> _hx_tmp7 = this->keysClick;
HXDLIN( 575)			this->_addToKeys(_hx_tmp7, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,13,null(),null()));
            		}
HXLINE( 577)		if (((code & 16) == 16)) {
HXLINE( 578)			::Array< ::Dynamic> _hx_tmp8 = this->keysRight;
HXDLIN( 578)			this->_addToKeys(_hx_tmp8, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,68,null(),null()));
HXLINE( 579)			::Array< ::Dynamic> _hx_tmp9 = this->keysLeft;
HXDLIN( 579)			this->_addToKeys(_hx_tmp9, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,65,null(),null()));
HXLINE( 580)			::Array< ::Dynamic> _hx_tmp10 = this->keysDown;
HXDLIN( 580)			this->_addToKeys(_hx_tmp10, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,83,null(),null()));
HXLINE( 581)			::Array< ::Dynamic> _hx_tmp11 = this->keysUp;
HXDLIN( 581)			this->_addToKeys(_hx_tmp11, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,87,null(),null()));
HXLINE( 582)			::Array< ::Dynamic> _hx_tmp12 = this->keysClick;
HXDLIN( 582)			this->_addToKeys(_hx_tmp12, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,13,null(),null()));
            		}
HXLINE( 584)		if (((code & 4096) == 4096)) {
HXLINE( 585)			::Array< ::Dynamic> _hx_tmp13 = this->keysRight;
HXDLIN( 585)			this->_addToKeys(_hx_tmp13, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,102,null(),null()));
HXLINE( 586)			::Array< ::Dynamic> _hx_tmp14 = this->keysLeft;
HXDLIN( 586)			this->_addToKeys(_hx_tmp14, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,100,null(),null()));
HXLINE( 587)			::Array< ::Dynamic> _hx_tmp15 = this->keysDown;
HXDLIN( 587)			this->_addToKeys(_hx_tmp15, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,98,null(),null()));
HXLINE( 588)			::Array< ::Dynamic> _hx_tmp16 = this->keysUp;
HXDLIN( 588)			this->_addToKeys(_hx_tmp16, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,104,null(),null()));
HXLINE( 589)			::Array< ::Dynamic> _hx_tmp17 = this->keysClick;
HXDLIN( 589)			this->_addToKeys(_hx_tmp17, ::flixel::addons::ui::FlxMultiKey_obj::__alloc( HX_CTX ,13,null(),null()));
            		}
HXLINE( 594)		if (::hx::IsNull( this->get_gamepad() )) {
HXLINE( 596)			this->_gamepad = this->getGamepad(null());
            		}
HXLINE( 599)		if (((code & 65536) == 65536)) {
HXLINE( 600)			::Array< ::Dynamic> _hx_tmp18 = this->keysLeft;
HXDLIN( 600)			this->_addToKeys(_hx_tmp18, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),13,null(),null()));
HXLINE( 601)			::Array< ::Dynamic> _hx_tmp19 = this->keysRight;
HXDLIN( 601)			this->_addToKeys(_hx_tmp19, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),14,null(),null()));
HXLINE( 602)			::Array< ::Dynamic> _hx_tmp20 = this->keysDown;
HXDLIN( 602)			this->_addToKeys(_hx_tmp20, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),12,null(),null()));
HXLINE( 603)			::Array< ::Dynamic> _hx_tmp21 = this->keysUp;
HXDLIN( 603)			this->_addToKeys(_hx_tmp21, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),11,null(),null()));
HXLINE( 604)			::Array< ::Dynamic> _hx_tmp22 = this->keysClick;
HXDLIN( 604)			this->_addToKeys(_hx_tmp22, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),0,null(),null()));
            		}
HXLINE( 606)		if (((code & 268435456) == 268435456)) {
HXLINE( 607)			::Array< ::Dynamic> _hx_tmp23 = this->keysLeft;
HXDLIN( 607)			this->_addToKeys(_hx_tmp23, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),4,null(),null()));
HXLINE( 608)			::Array< ::Dynamic> _hx_tmp24 = this->keysRight;
HXDLIN( 608)			this->_addToKeys(_hx_tmp24, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),5,null(),null()));
HXLINE( 609)			::Array< ::Dynamic> _hx_tmp25 = this->keysClick;
HXDLIN( 609)			this->_addToKeys(_hx_tmp25, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),0,null(),null()));
            		}
HXLINE( 611)		if (((code & 1048576) == 1048576)) {
...
HXDLIN( 616)			this->_addToKeys(_hx_tmp34, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),0,null(),null()));
            		}
HXLINE( 618)		if (((code & 16777216) == 16777216)) {
...
HXDLIN( 623)			this->_addToKeys(_hx_tmp43, ::flixel::addons::ui::FlxMultiGamepad_obj::__alloc( HX_CTX ,this->get_gamepad(),0,null(),null()));
            		}
            	}
...
HXDLIN( 651)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
...
HXLINE( 660)			int _g1 = 0;
HXDLIN( 660)			int _g2 = ::flixel::FlxG_obj::gamepads->get_numActiveGamepads();
HXDLIN( 660)			while((_g1 < _g2)){
HXLINE( 660)				_g1 = (_g1 + 1);
HXDLIN( 660)				int i1 = (_g1 - 1);
...
HXLINE( 676)		if (::hx::IsLess( a->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic),b->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic) )) {
HXLINE( 676)			return -1;
            		}
HXLINE( 677)		if (::hx::IsGreater( a->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic),b->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic) )) {
HXLINE( 677)			return 1;
            		}
HXLINE( 678)		return 0;
            	}
...
HXLINE( 682)		if (::hx::IsLess( a->__Field(HX_("y",79,00,00,00),::hx::paccDynamic),b->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) )) {
HXLINE( 682)			return -1;
            		}
HXLINE( 683)		if (::hx::IsGreater( a->__Field(HX_("y",79,00,00,00),::hx::paccDynamic),b->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) )) {
HXLINE( 683)			return 1;
            		}
HXLINE( 684)		if (::hx::IsLess( a->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),b->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) )) {
HXLINE( 684)			return -1;
            		}
HXLINE( 685)		if (::hx::IsGreater( a->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),b->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) )) {
HXLINE( 685)			return 1;
            		}
HXLINE( 686)		return 0;
            	}
...
HXLINE( 692)		if (::hx::IsLess( a->__Field(HX_("y",79,00,00,00),::hx::paccDynamic),b->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) )) {
HXLINE( 692)			return -1;
            		}
HXLINE( 693)		if (::hx::IsGreater( a->__Field(HX_("y",79,00,00,00),::hx::paccDynamic),b->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) )) {
HXLINE( 693)			return 1;
            		}
HXLINE( 694)		if (::hx::IsLess( a->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),b->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) )) {
HXLINE( 694)			return -1;
            		}
HXLINE( 695)		if (::hx::IsGreater( a->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),b->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) )) {
HXLINE( 695)			return 1;
            		}
HXLINE( 696)		return 0;
            	}
...
HXLINE( 734)					this->_doInput(0,-1,null());
...
HXDLIN( 738)			::Array< ::Dynamic> _g3 = this->keysDown;
HXDLIN( 738)			while((_g2 < _g3->length)){
HXLINE( 738)				 ::flixel::addons::ui::FlxBaseMultiInput key1 = _g3->__get(_g2).StaticCast<  ::flixel::addons::ui::FlxBaseMultiInput >();
HXDLIN( 738)				_g2 = (_g2 + 1);
HXLINE( 739)				if (key1->justPressed()) {
HXLINE( 740)					this->_doInput(0,1,null());
...
HXLINE( 744)		{
HXLINE( 744)			int _g4 = 0;
HXDLIN( 744)			::Array< ::Dynamic> _g5 = this->keysLeft;
HXDLIN( 744)			while((_g4 < _g5->length)){
HXLINE( 744)				 ::flixel::addons::ui::FlxBaseMultiInput key2 = _g5->__get(_g4).StaticCast<  ::flixel::addons::ui::FlxBaseMultiInput >();
HXDLIN( 744)				_g4 = (_g4 + 1);
HXLINE( 745)				if (key2->justPressed()) {
HXLINE( 746)					this->_doInput(-1,0,null());
...
HXDLIN( 750)			::Array< ::Dynamic> _g7 = this->keysRight;
HXDLIN( 750)			while((_g6 < _g7->length)){
HXLINE( 750)				 ::flixel::addons::ui::FlxBaseMultiInput key3 = _g7->__get(_g6).StaticCast<  ::flixel::addons::ui::FlxBaseMultiInput >();
HXDLIN( 750)				_g6 = (_g6 + 1);
HXLINE( 751)				if (key3->justPressed()) {
HXLINE( 752)					this->_doInput(1,0,null());
...
HXLINE( 757)			_hx_tmp = (lastLocation != -1);
            		}
            		else {
...
HXLINE( 767)				this->_clickTime = ( (Float)(0) );
...
HXLINE( 781)			if ((this->_clickTime > 0)) {
...
HXLINE( 826)		 ::flixel::math::FlxBasePoint widgetPoint = null();
HXLINE( 829)		if (::Std_obj::isOfType(currWidget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxObject >()) ))) {
HXLINE( 830)			fo = ( ( ::flixel::FlxObject)(currWidget) );
HXLINE( 832)			widgetPoint = fo->getScreenPosition(null(),null());
            		}
HXLINE( 835)		widgetPoint->set_x((widgetPoint->x * Camera->totalScaleX));
HXLINE( 836)		widgetPoint->set_y((widgetPoint->y * Camera->totalScaleY));
...
HXDLIN( 840)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 840)			point->_inPool = false;
HXDLIN( 840)			widgetPoint = point;
            		}
HXLINE( 844)		{
HXLINE( 844)			Float widgetPoint1 = widgetPoint->x;
HXDLIN( 844)			widgetPoint->set_x((widgetPoint1 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(currWidget) / ( (Float)(2) ))));
            		}
HXLINE( 845)		{
HXLINE( 845)			Float widgetPoint2 = widgetPoint->y;
HXDLIN( 845)			widgetPoint->set_y((widgetPoint2 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(currWidget) / ( (Float)(2) ))));
            		}
...
void FlxUICursor_obj::_doMouseMove( ::flixel::math::FlxBasePoint pt){
            	HX_GC_STACKFRAME(&_hx_pos_7e07195111da0df5_850__doMouseMove)
...
HXLINE( 860)		if (this->dispatchEvents) {
HXLINE( 865)			{
HXLINE( 865)				 ::flixel::input::mouse::FlxMouse _this = ::flixel::FlxG_obj::mouse;
HXDLIN( 865)				Float newY = pt->y;
HXDLIN( 865)				_this->_globalScreenX = ::Std_obj::_hx_int((pt->x / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 865)				_this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 865)				_this->updatePositions();
            			}
HXLINE( 867)			if (::hx::IsNotNull( this->_newMouse )) {
HXLINE( 869)				this->_newMouse->updateGlobalScreenPosition = false;
            			}
HXLINE( 873)			 ::openfl::display::Stage _hx_tmp = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 873)			Float pt1 = pt->x;
HXDLIN( 873)			Float pt2 = pt->y;
HXDLIN( 873)			 ::openfl::display::Stage _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 873)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 873)			bool _hx_tmp2 = _this1->keyManager->checkStatusUnsafe(17,_this1->status);
HXDLIN( 873)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 873)			bool _hx_tmp3 = _this2->keyManager->checkStatusUnsafe(18,_this2->status);
HXDLIN( 873)			 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 873)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseMove",d6,9b,b5,f4),true,false,pt1,pt2,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this3->keyManager->checkStatusUnsafe(16,_this3->status),null(),null(),null(),null(),null()));
            		}
...
void FlxUICursor_obj::_doPress( ::flixel::math::FlxBasePoint pt){
            	HX_GC_STACKFRAME(&_hx_pos_7e07195111da0df5_884__doPress)
...
HXLINE( 901)		if (this->dispatchEvents) {
HXLINE( 902)			Float rawMouseX = (pt->x * ::flixel::FlxG_obj::camera->zoom);
HXLINE( 903)			Float rawMouseY = (pt->y * ::flixel::FlxG_obj::camera->zoom);
HXLINE( 905)			 ::openfl::display::Stage _hx_tmp = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 905)			 ::openfl::display::Stage _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 905)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 905)			bool _hx_tmp2 = _this->keyManager->checkStatusUnsafe(17,_this->status);
HXDLIN( 905)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 905)			bool _hx_tmp3 = _this1->keyManager->checkStatusUnsafe(18,_this1->status);
HXDLIN( 905)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 905)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseDown",27,b1,c2,ee),true,false,rawMouseX,rawMouseY,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this2->keyManager->checkStatusUnsafe(16,_this2->status),null(),null(),null(),null(),null()));
            		}
...
void FlxUICursor_obj::_doRelease( ::flixel::math::FlxBasePoint pt){
            	HX_GC_STACKFRAME(&_hx_pos_7e07195111da0df5_921__doRelease)
...
HXLINE( 938)		Float rawMouseX = (pt->x * ::flixel::FlxG_obj::camera->zoom);
HXLINE( 939)		Float rawMouseY = (pt->y * ::flixel::FlxG_obj::camera->zoom);
HXLINE( 941)		if (this->dispatchEvents) {
HXLINE( 945)			 ::openfl::display::Stage _hx_tmp = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 945)			 ::openfl::display::Stage _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 945)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 945)			bool _hx_tmp2 = _this->keyManager->checkStatusUnsafe(17,_this->status);
HXDLIN( 945)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 945)			bool _hx_tmp3 = _this1->keyManager->checkStatusUnsafe(18,_this1->status);
HXDLIN( 945)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 945)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,rawMouseX,rawMouseY,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this2->keyManager->checkStatusUnsafe(16,_this2->status),null(),null(),null(),null(),null()));
HXLINE( 946)			if (this->_clickPressed) {
HXLINE( 947)				 ::openfl::display::Stage _hx_tmp4 = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 947)				 ::openfl::display::Stage _hx_tmp5 = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 947)				 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 947)				bool _hx_tmp6 = _this3->keyManager->checkStatusUnsafe(17,_this3->status);
HXDLIN( 947)				 ::flixel::input::keyboard::FlxKeyList _this4 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 947)				bool _hx_tmp7 = _this4->keyManager->checkStatusUnsafe(18,_this4->status);
HXDLIN( 947)				 ::flixel::input::keyboard::FlxKeyList _this5 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 947)				_hx_tmp4->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("click",48,7c,5e,48),true,false,rawMouseX,rawMouseY,_hx_tmp5,_hx_tmp6,_hx_tmp7,_this5->keyManager->checkStatusUnsafe(16,_this5->status),null(),null(),null(),null(),null()));
            			}
            		}
...
HXLINE( 965)		if (::hx::IsNotNull( this->_newMouse )) {
HXLINE( 967)			this->_newMouse->updateGlobalScreenPosition = true;
HXLINE( 968)			{
HXLINE( 968)				 ::flixel::addons::ui::FlxUIMouse _this6 = this->_newMouse;
HXDLIN( 968)				Float newX = ( (Float)(::Std_obj::_hx_int(::flixel::FlxG_obj::game->get_mouseX())) );
HXDLIN( 968)				Float newY = ( (Float)(::Std_obj::_hx_int(::flixel::FlxG_obj::game->get_mouseY())) );
HXDLIN( 968)				_this6->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 968)				_this6->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 968)				_this6->updatePositions();
            			}
            		}
            	}
...
HXLINE( 975)		int currX = 0;
HXLINE( 976)		int currY = 0;
HXLINE( 977)		int length = 0;
...
HXLINE( 992)		int nextX = 0;
HXLINE( 993)		int nextY = 0;
...
HXLINE(1001)		int besti = -1;
HXLINE(1006)		{
HXLINE(1006)			int _g = 0;
HXDLIN(1006)			int _g1 = length;
...
HXLINE(1021)					dy = ( (Float)((nextY - currY)) );
HXLINE(1022)					bool _hx_tmp;
HXDLIN(1022)					int _hx_tmp1;
HXDLIN(1022)					if ((dy < 0)) {
HXLINE(1022)						_hx_tmp1 = -1;
            					}
            					else {
HXLINE(1022)						_hx_tmp1 = 1;
            					}
...
HXDLIN(1022)					if ((Y < 0)) {
HXLINE(1022)						_hx_tmp2 = -1;
            					}
            					else {
HXLINE(1022)						_hx_tmp2 = 1;
            					}
HXDLIN(1022)					if ((_hx_tmp1 == _hx_tmp2)) {
HXLINE(1022)						_hx_tmp = (dy != 0);
            					}
            					else {
...
HXLINE(1028)							bestdx = ::Math_obj::abs(( (Float)((currX - nextX)) ));
HXLINE(1029)							besti = i;
            						}
            						else {
HXLINE(1031)							if ((dy == bestdy)) {
HXLINE(1033)								dx = ::Math_obj::abs(( (Float)((currX - nextX)) ));
...
HXLINE(1067)		int besti = -1;
HXLINE(1069)		bestdx = ::Math_obj::POSITIVE_INFINITY;
HXLINE(1070)		bestdy = ( (Float)(0) );
HXLINE(1072)		int length = 0;
HXLINE(1073)		int currX = 0;
HXLINE(1074)		int currY = 0;
...
HXLINE(1106)					dy = ( (Float)((yy - currY)) );
HXLINE(1108)					bool _hx_tmp;
HXDLIN(1108)					int _hx_tmp1;
HXDLIN(1108)					if ((dy < 0)) {
HXLINE(1108)						_hx_tmp1 = -1;
            					}
            					else {
HXLINE(1108)						_hx_tmp1 = 1;
            					}
...
HXDLIN(1108)					if ((Y < 0)) {
HXLINE(1108)						_hx_tmp2 = -1;
            					}
            					else {
HXLINE(1108)						_hx_tmp2 = 1;
            					}
HXDLIN(1108)					if (((_hx_tmp1 == _hx_tmp2) == false)) {
HXLINE(1108)						_hx_tmp = (dy != 0);
            					}
            					else {
...
HXLINE(1113)							bestdx = ::Math_obj::abs(( (Float)((currX - xx)) ));
HXLINE(1114)							besti = i;
            						}
            						else {
HXLINE(1116)							if ((dy == bestdy)) {
HXLINE(1118)								dx = ::Math_obj::abs(( (Float)((currX - xx)) ));
...
HXDLIN(1148)			if (((this->location + X) >= 0)) {
...
HXLINE(1170)						if ((X == -1)) {
HXLINE(1172)							this->set_location((this->_widgets->length - 1));
            						}
            					}
            				}
            			}
...
HXLINE(1210)						if ((Y == -1)) {
HXLINE(1212)							this->set_location((this->_widgets->length - 1));
            						}
            					}
...
HXDLIN(1222)			if (::hx::IsEq( currWidget->__Field(HX_("visible",72,78,24,a3),::hx::paccDynamic),false )) {
...
HXLINE(1224)				this->_doInput(X,Y,(recursion + 1));
HXLINE(1225)				return;
            			}
            		}
...
HXDLIN(1240)		if ((this->location >= 0)) {
...
HXLINE(1255)			if (::Std_obj::isOfType(target,( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxSprite >()) ))) {
...
HXLINE(1260)					 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
HXDLIN(1260)					Float y = fs->scrollFactor->y;
HXDLIN(1260)					this1->set_x(fs->scrollFactor->x);
HXDLIN(1260)					this1->set_y(y);
            				}
            			}
HXLINE(1264)			if (::Std_obj::isOfType(currWidget,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUICheckBox >()) ))) {
