...
HXLINE(  69)		if ((this->resize_ratio > 0)) {
HXLINE(  71)			Float effective_ratio = (w / h);
HXLINE(  72)			if ((::Math_obj::abs((effective_ratio - this->resize_ratio)) > ((Float)0.0001))) {
HXLINE(  74)				if ((this->resize_ratio_axis == 1)) {
HXLINE(  76)					h = (w * (( (Float)(1) ) / this->resize_ratio));
            				}
            				else {
HXLINE(  80)					w = (h * (( (Float)(1) ) / this->resize_ratio));
            				}
            			}
            		}
...
HXLINE( 101)			this->set_x((this->x - delta_x));
HXLINE( 102)			this->set_y((this->y - delta_y));
            		}
            	}
