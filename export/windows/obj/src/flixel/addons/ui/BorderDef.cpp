...
HXLINE(  34)		int border_color = ( (int)(::flixel::addons::ui::U_obj::xml_color(data,HX_("border_color",90,7e,e8,6e),true,0)) );
HXLINE(  35)		Float border_size = ::flixel::addons::ui::U_obj::xml_f(data,HX_("border_size",34,18,b0,f8),1);
HXLINE(  36)		Float border_quality = ::flixel::addons::ui::U_obj::xml_f(data,HX_("border_quality",2c,77,d7,ad),0);
...
HXLINE(  52)					return_val = 0;
            				}
HXDLIN(  52)				borderDef->color = ( (int)(return_val) );
            			}
            			else {
...
HXLINE(  57)						return_val1 = 0;
            					}
HXDLIN(  57)					borderDef->color = ( (int)(return_val1) );
            				}
            				else {
...
HXLINE(  62)							return_val2 = 0;
            						}
HXDLIN(  62)						borderDef->color = ( (int)(return_val2) );
            					}
            				}
            			}
