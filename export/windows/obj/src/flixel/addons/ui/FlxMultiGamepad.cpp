...
HXDLIN(  31)		switch((int)(ID)){
            			case (int)-2: {
HXLINE(  31)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXLINE(  31)				return !(_this->anyButton(Status));
            			...
            			break;
            			default:{
HXLINE(  31)				int RawID = _this->mapping->getRawID(ID);
...
HXLINE(  31)					return button->hasState(Status);
            				}
            				else {
...
HXDLIN(  37)		int ID = this->input;
HXDLIN(  37)		int Status = -1;
HXDLIN(  37)		switch((int)(ID)){
            			case (int)-2: {
HXLINE(  37)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXLINE(  37)				return !(_this->anyButton(Status));
            			...
            			break;
            			default:{
HXLINE(  37)				int RawID = _this->mapping->getRawID(ID);
...
HXDLIN(  37)				if (::hx::IsNotNull( button )) {
HXLINE(  37)					return button->hasState(Status);
            				}
            				else {
...
HXDLIN(  43)		int ID = this->input;
HXDLIN(  43)		int Status = 1;
HXDLIN(  43)		switch((int)(ID)){
            			case (int)-2: {
HXLINE(  43)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXLINE(  43)				return !(_this->anyButton(Status));
            			...
            			break;
            			default:{
HXLINE(  43)				int RawID = _this->mapping->getRawID(ID);
...
HXLINE(  43)					return button->hasState(Status);
            				}
            				else {
...
HXLINE(  49)		return (this->gamepad->checkButtonArrayState(this->combos,1) == value);
            	}
...
HXLINE(  55)		return (this->gamepad->checkButtonArrayState(this->forbiddens,1) == value);
            	}
