...
HXLINE(  15)		this->scrollIndex = 0;
HXLINE(  72)		this->_skipRefresh = true;
HXLINE(  73)		super::__construct(X,Y);
HXLINE(  74)		this->set_stacking(( (int)(Stacking) ));
HXLINE(  75)		this->set_spacing(( (Float)(Spacing) ));
...
HXLINE(  89)				_g1->onClick(i);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE(  89)			 ::flixel::addons::ui::FlxUIList _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  89)			int i = -1;
HXDLIN(  89)			 ::flixel::addons::ui::FlxUIButton pButton =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_0(_g1,i)),null(),null(),null());
HXLINE(  90)			if ((this->stacking == 0)) {
...
HXDLIN( 100)				pButton3->set_width(( ( ::flixel::text::FlxText)(pButton->label) )->set_fieldWidth(( (Float)(100) )));
HXLINE( 101)				 ::flixel::addons::ui::FlxUIText pButton4 = ( ( ::flixel::addons::ui::FlxUIText)(pButton->label) );
HXDLIN( 101)				pButton4->set_text(this->getMoreString(0));
HXLINE( 102)				pButton->setAllLabelOffsets(( (Float)(0) ),( (Float)(0) ));
HXLINE( 103)				Float _hx_tmp2 = (pButton->get_width() + 2);
...
HXLINE( 110)			if (::Std_obj::isOfType(this->prevButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >()) ))) {
...
HXLINE( 113)					_g2->onClick(i1);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 112)				 ::flixel::addons::ui::FlxUIButton fuib = ( ( ::flixel::addons::ui::FlxUIButton)(this->prevButton) );
HXLINE( 113)				 ::flixel::addons::ui::FlxUIList _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 113)				int i1 = -1;
HXDLIN( 113)				 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_1(_g2,i1));
HXDLIN( 113)				fuib->onUp->callback = _hx_tmp4;
            			}
HXLINE( 115)			if (::Std_obj::isOfType(this->prevButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUISpriteButton >()) ))) {
...
HXLINE( 118)					_g3->onClick(i2);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 117)				 ::flixel::addons::ui::FlxUISpriteButton fusb = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->prevButton) );
HXLINE( 118)				 ::flixel::addons::ui::FlxUIList _g3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 118)				int i2 = -1;
HXDLIN( 118)				 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_2(_g3,i2));
...
HXLINE( 123)				_g4->onClick(i3);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 123)			 ::flixel::addons::ui::FlxUIList _g4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 123)			int i3 = 1;
HXDLIN( 123)			 ::flixel::addons::ui::FlxUIButton nButton =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_3(_g4,i3)),null(),null(),null());
HXLINE( 124)			if ((this->stacking == 0)) {
...
HXDLIN( 126)				nButton1->set_width(( ( ::flixel::text::FlxText)(nButton->label) )->set_fieldWidth(( (Float)(100) )));
HXLINE( 127)				 ::flixel::addons::ui::FlxUIText nButton2 = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
HXDLIN( 127)				nButton2->set_text(this->getMoreString(0));
HXLINE( 128)				nButton->setAllLabelOffsets(( (Float)(0) ),(nButton->get_height() + 2));
...
HXDLIN( 132)				nButton3->set_width(( ( ::flixel::text::FlxText)(nButton->label) )->set_fieldWidth(( (Float)(100) )));
HXLINE( 133)				 ::flixel::addons::ui::FlxUIText nButton4 = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
HXDLIN( 133)				nButton4->set_text(this->getMoreString(0));
HXLINE( 134)				nButton->setAllLabelOffsets(( (Float)(0) ),( (Float)(0) ));
HXLINE( 135)				nButton->setCenterLabelOffset((nButton->get_width() + 2),( (Float)(0) ));
HXLINE( 136)				( ( ::flixel::text::FlxText)(nButton->label) )->set_alignment(HX_("left",07,08,b0,47));
            			}
HXLINE( 138)			this->nextButton = nButton;
            		}
            		else {
HXLINE( 142)			if (::Std_obj::isOfType(this->nextButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >()) ))) {
...
HXLINE( 145)					_g5->onClick(i4);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 144)				 ::flixel::addons::ui::FlxUIButton fuib1 = ( ( ::flixel::addons::ui::FlxUIButton)(this->nextButton) );
HXLINE( 145)				 ::flixel::addons::ui::FlxUIList _g5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 145)				int i4 = 1;
HXDLIN( 145)				 ::Dynamic _hx_tmp6 =  ::Dynamic(new _hx_Closure_4(i4,_g5));
HXDLIN( 145)				fuib1->onUp->callback = _hx_tmp6;
            			}
HXLINE( 147)			if (::Std_obj::isOfType(this->nextButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUISpriteButton >()) ))) {
...
HXLINE( 150)					_g6->onClick(i5);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 149)				 ::flixel::addons::ui::FlxUISpriteButton fusb1 = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->nextButton) );
HXLINE( 150)				 ::flixel::addons::ui::FlxUIList _g6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 150)				int i5 = 1;
HXDLIN( 150)				 ::Dynamic _hx_tmp7 =  ::Dynamic(new _hx_Closure_5(_g6,i5));
HXDLIN( 150)				fusb1->onUp->callback = _hx_tmp7;
            			}
            		}
HXLINE( 154)		if (::hx::IsNull( this->prevButtonOffset )) {
HXLINE( 155)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 155)			point->_inPool = false;
HXDLIN( 155)			this->prevButtonOffset = point;
            		}
HXLINE( 157)		if (::hx::IsNull( this->nextButtonOffset )) {
HXLINE( 158)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
...
HXLINE( 206)		while((newString.indexOf(HX_("<X>",22,d4,2d,00),null()) != -1)){
...
HXLINE( 220)		this->set_scrollIndex((this->scrollIndex + i));
...
HXLINE( 231)		if ((this->group->members->indexOf(( ( ::flixel::FlxSprite)(this->prevButton) ),null()) != -1)) {
HXLINE( 232)			this->remove(( ( ::flixel::FlxSprite)(this->prevButton) ),true);
            		}
HXLINE( 234)		if ((this->group->members->indexOf(( ( ::flixel::FlxSprite)(this->nextButton) ),null()) != -1)) {
HXLINE( 235)			this->remove(( ( ::flixel::FlxSprite)(this->nextButton) ),true);
            		}
HXLINE( 238)		Float XX = ( (Float)(0) );
HXLINE( 239)		Float YY = ( (Float)(0) );
HXLINE( 241)		int i = 0;
HXLINE( 242)		bool inBounds = true;
HXLINE( 244)		if ((this->stacking == 0)) {
HXLINE( 245)			::Dynamic _hx_tmp = this->prevButton;
HXDLIN( 245)			Float _hx_tmp1 = this->prevButtonOffset->x;
HXDLIN( 245)			::flixel::IFlxSprite_obj::set_x(_hx_tmp,((_hx_tmp1 - ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(this->prevButton)) - ( (Float)(2) )));
...
HXDLIN( 247)			::flixel::IFlxSprite_obj::set_x(_hx_tmp2,((_hx_tmp3 + this->get_width()) + 2));
...
HXDLIN( 251)			::flixel::IFlxSprite_obj::set_y(_hx_tmp4,((_hx_tmp5 - ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(this->prevButton)) - ( (Float)(2) )));
...
HXDLIN( 253)			::flixel::IFlxSprite_obj::set_y(_hx_tmp6,((_hx_tmp7 + this->get_height()) + 2));
            		}
...
HXLINE( 270)							inBounds = (this->get_width() <= 0);
            						}
            						else {
...
HXLINE( 290)					widget->set_x(widget->set_y(( (Float)(0) )));
...
HXLINE( 297)		this->amountNext = (this->group->members->get_length() - (highestIndex + 1));
HXLINE( 299)		 ::flixel::addons::ui::FlxUIButton fuibutton;
HXLINE( 301)		if ((this->amountPrevious > 0)) {
HXLINE( 302)			this->safeAdd(( ( ::flixel::FlxSprite)(this->prevButton) ));
HXLINE( 303)			if (::Std_obj::isOfType(this->prevButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >()) ))) {
...
HXLINE( 308)		if ((this->amountNext > 0)) {
HXLINE( 309)			this->safeAdd(( ( ::flixel::FlxSprite)(this->nextButton) ));
HXLINE( 310)			if (::Std_obj::isOfType(this->nextButton,( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::ui::FlxUIButton >()) ))) {
...
HXDLIN(  11)		STACK_HORIZONTAL = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_a5e703d0cd5c8e74_12_boot)
HXDLIN(  12)		STACK_VERTICAL = 1;
            	}
}
