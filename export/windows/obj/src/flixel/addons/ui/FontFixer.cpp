...
HX_LOCAL_STACK_FRAME(_hx_pos_104c949d5af4b7b2_19_init,"flixel.addons.ui.FontFixer","init",0xc699013c,"flixel.addons.ui.FontFixer.init","flixel/addons/ui/FontFixer.hx",19,0x44f16d9d)
HX_LOCAL_STACK_FRAME(_hx_pos_104c949d5af4b7b2_26_fix,"flixel.addons.ui.FontFixer","fix",0x1c6ee529,"flixel.addons.ui.FontFixer.fix","flixel/addons/ui/FontFixer.hx",26,0x44f16d9d)
HX_LOCAL_STACK_FRAME(_hx_pos_104c949d5af4b7b2_39_add,"flixel.addons.ui.FontFixer","add",0x1c6b1575,"flixel.addons.ui.FontFixer.add","flixel/addons/ui/FontFixer.hx",39,0x44f16d9d)
namespace flixel{
namespace addons{
namespace ui{
...
void FontFixer_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_104c949d5af4b7b2_19_init)
HXDLIN(  19)		if (::hx::IsNull( ::flixel::addons::ui::FontFixer_obj::name2File )) {
HXLINE(  21)			::flixel::addons::ui::FontFixer_obj::name2File =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
            	}
...
::String FontFixer_obj::fix(::String font){
            	HX_STACKFRAME(&_hx_pos_104c949d5af4b7b2_26_fix)
HXLINE(  27)		::flixel::addons::ui::FontFixer_obj::init();
HXLINE(  28)		if ((font.indexOf(HX_(".ttf",78,3b,c0,1e),null()) == -1)) {
HXLINE(  30)			if (::flixel::addons::ui::FontFixer_obj::name2File->exists(font)) {
HXLINE(  32)				font = ::flixel::addons::ui::FontFixer_obj::name2File->get_string(font);
            			}
            		}
HXLINE(  35)		return font;
            	}
...
::String FontFixer_obj::add(::String file,::String __o_name){
            	...
            	HX_STACKFRAME(&_hx_pos_104c949d5af4b7b2_39_add)
HXLINE(  40)		::flixel::addons::ui::FontFixer_obj::init();
HXLINE(  41)		bool _hx_tmp;
HXDLIN(  41)		if ((name != HX_("",00,00,00,00))) {
HXLINE(  41)			_hx_tmp = ::flixel::addons::ui::FontFixer_obj::name2File->exists(name);
            		}
            		else {
HXLINE(  41)			_hx_tmp = false;
            		}
HXDLIN(  41)		if (_hx_tmp) {
HXLINE(  43)			return ::flixel::addons::ui::FontFixer_obj::name2File->get_string(name);
            		}
HXLINE(  46)		if (!(::openfl::utils::Assets_obj::exists(file,HX_("FONT",cf,25,81,2e)))) {
HXLINE(  48)			return file;
            		}
HXLINE(  51)		 ::openfl::text::Font font = ::openfl::utils::Assets_obj::getFont(file,null());
HXLINE(  52)		if (::hx::IsNull( font )) {
HXLINE(  54)			return file;
            		}
HXLINE(  57)		if ((name == HX_("",00,00,00,00))) {
HXLINE(  59)			name = font->name;
            		}
HXLINE(  76)		::flixel::addons::ui::FontFixer_obj::name2File->set(name,file);
HXLINE(  77)		return ::flixel::addons::ui::FontFixer_obj::fix(file);
            	}
