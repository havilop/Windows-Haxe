...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Windows Haxe",23,e3,ac,f2),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("28",c6,2b,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Windows Haxe",23,e3,ac,f2));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Installing Windows 7",a1,ba,56,63));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Installing Windows 7",a1,ba,56,63))
            			...
            			->setFixed(13,HX_("frameRate",ad,11,25,39),75)
