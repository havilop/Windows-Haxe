...
class HXCPP_CLASS_ATTRIBUTES FlxUIState_obj : public  ::flixel::FlxState_obj
{
	public:
	...
	public:
		...
		static ::hx::ObjectPtr< FlxUIState_obj > __new();
		static ::hx::ObjectPtr< FlxUIState_obj > __alloc(::hx::Ctx *_hx_ctx);
